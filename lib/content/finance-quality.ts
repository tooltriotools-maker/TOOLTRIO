...
export const FINANCE_BATCH_01: FinanceQualityProfile[] = [
  ...
  {
    slug: '401k-early-withdrawal-vs-loan-calculator', status: 'tax_rule_review',
    methodology: 'Scenario comparison of a taxable early distribution versus a participant loan using user-entered assumptions.',
  ...
  {
    slug: '401k-vs-pension-calculator', status: 'tax_rule_review',
  ...
  {
    slug: '401k-vs-roth-ira-calculator', status: 'tax_rule_review',
  ...
  {
    slug: '529-to-roth-rollover-calculator', status: 'tax_rule_review',
  ...
  {
    slug: '529-vs-roth-ira-education-calculator', status: 'tax_rule_review',
  ...
  {
    slug: '529-vs-utma-calculator', status: 'tax_rule_review',
  ...
  {
    slug: '72t-sepp-calculator', status: 'tax_rule_review',
  ...
  {
    slug: 'alimony-calculator', status: 'tax_rule_review',
  ...
  {
    slug: 'alimony-tax-calculator', status: 'tax_rule_review',
  ...
  {
    slug: 'alternative-minimum-tax-calculator', status: 'tax_rule_review',
    ...
    sources: [{ title: 'IRS Topic 556 — Alternative Minimum Tax', url: `${IRS}/taxtopics/tc556` }], currentYear: 2026,
  },
  {
    slug: 'annual-bonus-tax-calculator', status: 'tax_rule_review',
  ...
  {
    slug: 'backdoor-roth-ira-calculator', status: 'tax_rule_review',
  ...
  {
    slug: 'bonds-vs-cds-usa-calculator', status: 'tax_rule_review',
    methodology: 'After-tax yield comparison using user-entered federal/state tax assumptions and product yields.',
    limitations: ['Treasury and CD tax treatment, insurance, liquidity, and reinvestment risk differ.', 'Rates are time-sensitive.'],
    sources: [], currentYear: 2026,
  },
  {
    slug: 'bonus-depreciation-calculator', status: 'tax_rule_review',
