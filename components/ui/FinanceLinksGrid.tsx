...
const ALL_FINANCE_CALCS: CalcLink[] = [
  ...
  // Retirement (new additions, merged from V7)
  { name: 'Inherited IRA Calculator', href: '/calculators/finance/inherited-ira-calculator', icon: '🏛️', cat: 'Retirement' },
  { name: 'Rule 72(t) SEPP Calculator', href: '/calculators/finance/72t-sepp-calculator', icon: '🔓', cat: 'Retirement' },
  { name: 'Net Unrealized Appreciation', href: '/calculators/finance/net-unrealized-appreciation-calculator', icon: '📊', cat: 'Retirement' },
  { name: 'Safe Harbor 401(k)', href: '/calculators/finance/safe-harbor-401k-calculator', icon: '🛡️', cat: 'Retirement' },
  { name: 'Defined Benefit Pension', href: '/calculators/finance/defined-benefit-pension-calculator', icon: '🏛️', cat: 'Retirement' },
  { name: 'HSA Triple Tax Growth', href: '/calculators/finance/hsa-triple-tax-growth-calculator', icon: '🏥', cat: 'Retirement' },
  { name: 'Social Security WEP', href: '/calculators/finance/social-security-wep-calculator', icon: '⚖️', cat: 'Retirement' },
  { name: '529 Prepaid vs Savings', href: '/calculators/finance/prepaid-vs-savings-529-calculator', icon: '🎓', cat: 'Retirement' },
  { name: 'Series EE Bond Calculator', href: '/calculators/finance/series-ee-bond-calculator', icon: '🏦', cat: 'Retirement' },
  // Tax
  ...
  // Tax (new additions, merged from V7)
  { name: 'W-2 vs 1099 Calculator', href: '/calculators/finance/w2-vs-1099-calculator', icon: '⚖️', cat: 'Tax' },
  { name: 'FICA Tax Calculator', href: '/calculators/finance/fica-tax-calculator', icon: '🏛️', cat: 'Tax' },
  { name: 'Qualified Dividend Tax', href: '/calculators/finance/qualified-dividend-tax-calculator', icon: '💰', cat: 'Tax' },
  { name: 'Wash Sale Calculator', href: '/calculators/finance/wash-sale-calculator', icon: '🔄', cat: 'Tax' },
  { name: 'Bonus Depreciation (Sec 179)', href: '/calculators/finance/bonus-depreciation-calculator', icon: '🏗️', cat: 'Tax' },
  { name: 'Stock Option Tax (ISO/NSO)', href: '/calculators/finance/stock-option-tax-calculator', icon: '💎', cat: 'Tax' },
  { name: 'Charitable Giving Tax', href: '/calculators/finance/charitable-giving-tax-calculator', icon: '❤️', cat: 'Tax' },
  { name: 'Alimony Tax Calculator', href: '/calculators/finance/alimony-tax-calculator', icon: '⚖️', cat: 'Tax' },
  { name: 'Home Office Deduction', href: '/calculators/finance/home-office-deduction-calculator', icon: '🏠', cat: 'Tax' },
  { name: 'Freelancer Quarterly Tax', href: '/calculators/finance/freelancer-quarterly-tax-calculator', icon: '📅', cat: 'Tax' },
  { name: 'Capital Gains Harvesting', href: '/calculators/finance/capital-gains-harvesting-calculator', icon: '🌱', cat: 'Tax' },
  // Budget & Savings
  ...
  // Investment (new additions, merged from V7)
  { name: 'COBRA vs Marketplace', href: '/calculators/finance/cobra-vs-marketplace-calculator', icon: '🏥', cat: 'Investing' },
  { name: 'FHA vs Conventional', href: '/calculators/finance/fha-vs-conventional-calculator', icon: '🏡', cat: 'Investing' },
  { name: 'Rental Depreciation', href: '/calculators/finance/rental-property-depreciation-calculator', icon: '🏘️', cat: 'Investing' },
  { name: 'T-Bill Calculator', href: '/calculators/finance/treasury-bill-calculator', icon: '🏦', cat: 'Investing' },
  { name: 'Margin Trading Calculator', href: '/calculators/finance/margin-trading-calculator', icon: '📉', cat: 'Investing' },
  // Real Estate
