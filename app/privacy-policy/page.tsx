...
const sections = [
  ['1. Using ToolTrio without an account', 'ToolTrio does not require an account to use its public ZIP code or fun tools. You can use ZIP Code Lookup, ZIP Code Distance, ZIP Code Timezone, ZIP+4, coordinate and nearby-ZIP tools without creating a profile.'],
