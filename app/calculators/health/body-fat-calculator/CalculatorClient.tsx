...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Body Fat Calculator" description="Calculate body fat percentage using the US Navy method. Get fat mass, lean mass, and fitness category." icon="💪" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="body-fat-calculator">
...
<InputField label="Waist (at navel)" value={waist} onChange={setWaist} min={50} max={200} step={0.5} suffix="cm" />
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Body Fat Calculator** is a a health information tool using the method and reference data described for this calculator. Get your body fat instantly - no account needed, works on all devices.
...
Combine this with [our BMI Calculator](/calculators/health/bmi-calculator), [our Lean Body Mass Calculator](/calculators/health/lean-body-mass-calculator) for a complete picture.`}
        howItWorks={`**The science behind the Body Fat Calculator:** This tool applies the calculation method described for body fat in clinical and research settings across the United States and internationally.
...
**Limitations to understand:** This calculator provides population-average estimates. Individual factors including genetics, medications, medical conditions, hydration status, and measurement timing can affect results. For medical decisions, always consult your healthcare provider.`}
        benefits={[
          { title: "Real-Time Body Fat Calculator results as You Type", text: "Results update the moment you change any input - there's no button to click and no page to reload. This makes the Body Fat Calculator fast and intuitive, letting you explore dozens of different scenarios in minutes and develop a genuine feel for how each variable affects your outcome." },
          { title: "Body Fat Calculator methodology and assumptions & Guidelines", text: "The methodology should be interpreted alongside the specific formula and sources described for this calculator; a health result is an estimate and should not be treated as a clinical diagnosis. " },
