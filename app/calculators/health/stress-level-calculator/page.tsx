...
const faqs = [
  ...
  {question:'What are the most evidence-based stress reduction techniques?',answer:`Interventions with the strongest RCT evidence: Mindfulness-Based Stress Reduction (MBSR) — the 8-week structured program reduces cortisol, self-reported stress, and anxiety with effect sizes comparable to medication in some populations. Regular aerobic exercise reduces cortisol reactivity, increases BDNF, and produces antidepressant and anxiolytic effects through multiple pathways. Cognitive behavioral therapy (CBT) — particularly for stress rooted in cognitive appraisal patterns — addresses the thought patterns that amplify stress responses. Social connection — perceived social support is one of the most useful stress buffers, reducing cortisol responses to stressors by 20-30% in laboratory studies. Progressive muscle relaxation, diaphragmatic breathing, and yoga all have consistent evidence for HPA axis downregulation.`},
...
const seoContent = {
  healthSourceProfile: 'stress-level-calculator',
