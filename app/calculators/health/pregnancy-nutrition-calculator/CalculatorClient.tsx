...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Pregnancy Nutrition Calculator" description="Calculate calorie and nutrient requirements during pregnancy by trimester." icon="🤰" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="pregnancy-nutrition-calculator">
