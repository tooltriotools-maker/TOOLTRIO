...
const auditFaqs = [
  {"question": "What should I check before using the Muscle Recovery Time Calculator?", "answer": "Check Sets completed, Your age, Sleep last night, Protein today, Body weight, Recovery Time and make sure each value uses the unit or format requested by the calculator. The result is based on the values you enter."},
  {"question": "How should I interpret the Muscle Recovery Time Calculator result?", "answer": "Read the result together with the inputs and assumptions shown on the page. It is a calculator output for informational use and is not a diagnosis or a substitute for evaluation by a qualified healthcare professional."},
  {"question": "How can I compare different Muscle Recovery Time Calculator scenarios?", "answer": "Change one input at a time while keeping the other values unchanged. Comparing results this way makes it easier to see which input is responsible for the difference."}
];
...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Muscle Recovery Time Calculator" description="Calculate personalised muscle recovery time based on muscle group, training intensity, age, sleep, and protein intake." icon="💪" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="muscle-recovery-time-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to interpret this muscle recovery time calculator</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>This tool uses Sets completed, Your age, Sleep last night, Protein today, Body weight, Recovery Time, Recovery Days to calculate the displayed result. The output reflects the formula implemented on this page and the values you enter.</p>
