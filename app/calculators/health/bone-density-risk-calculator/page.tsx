...
const faqs = [
  {"question": "What are the main risk factors for osteoporosis?", "answer": "The strongest risk factors for osteoporosis are female sex (especially post-menopausal), advanced age (risk doubles each decade after 50), low body weight (BMI < 18.5), family history of hip fracture, long-term corticosteroid use (> 3 months), and smoking. Secondary causes include low calcium intake, vitamin D deficiency, excessive alcohol, low physical activity, and certain medications (proton pump inhibitors, anticonvulsants, some chemotherapy drugs). The good news is most of these risk factors are modifiable or can prompt early DEXA scan screening."},
  {"question": "At what age should I get a DEXA bone density scan?", "answer": "The US Preventive Services Task Force (USPSTF) recommends routine DEXA screening for all women aged 65 and older, and for younger postmenopausal women with elevated fracture risk based on tools like FRAX or this calculator. For men, routine screening is less standardized but is generally recommended after age 70 or at any age with multiple risk factors. If you are taking long-term corticosteroids, DEXA scanning is recommended regardless of age after 3+ months of use."},
  {"question": "How much calcium and vitamin D do I need for bone health?", "answer": "The National Osteoporosis Foundation recommends 1,000 mg/day of calcium for adults under 50, and 1,200 mg/day for women over 50 and men over 70. Vitamin D recommendations are 800-1,000 IU/day for most adults, and up to 2,000 IU/day for those at risk of deficiency. Calcium from food is preferred over supplements — good sources include dairy, fortified foods, sardines, and leafy greens. Vitamin D3 (cholecalciferol) is the preferred supplement form."}
]
...
export default function Page() {
  ...
  return (
    <>
      ...
      />
          <CalculatorBatch47DeepDive slug="bone-density-risk-calculator" />
</>
  )
}
