...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Kidney Function Calculator" description="Estimate eGFR (kidney function) and CKD stage using the CKD-EPI formula." icon="🫘" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="kidney-function-calculator">
