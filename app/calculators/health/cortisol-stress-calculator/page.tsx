...
Social connection is one of the most potent HPA axis regulators. Research by Coan et al. (2006) showed that simply holding a spouse's hand during a stress task reduced hypothalamic activation measurably — even brief positive social contact modulates cortisol reactivity.`,
  ...
  conclusion: `The lifestyle interventions with the strongest evidence for normalizing cortisol rhythm are, in rough order of effect size: consistent sleep/wake timing (the most useful regulator of the cortisol awakening response), regular moderate-intensity exercise (reduces baseline cortisol and improves recovery), stress reduction practices (MBSR and breathing techniques reduce cortisol reactivity over weeks), and appropriate caffeine timing.
