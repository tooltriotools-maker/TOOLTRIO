...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Stroke Risk Calculator" description="Estimate your 10-year stroke risk using validated clinical risk factors." icon="🧠" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="stroke-risk-calculator">
