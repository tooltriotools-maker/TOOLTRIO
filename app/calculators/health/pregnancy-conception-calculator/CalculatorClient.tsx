...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Conception Probability Calculator" description="Calculate your personalised health score and get actionable recommendations based on your individual data." icon="🌱" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="pregnancy-conception-calculator">
...
<InputField label="Age" value={age} onChange={setAge} min={15} max={90} step={1} suffix="yrs" />
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Pregnancy Conception Calculator** is a a health information tool using the method and reference data described for this calculator. Get your pregnancy conception instantly - no account needed, works on all devices.
...
Combine this with [our BMI Calculator](/calculators/health/bmi-calculator), [our Calorie Calculator](/calculators/health/calorie-calculator) for a complete picture.`}
        howItWorks={`**The science behind the Pregnancy Conception Calculator:** This tool applies the calculation method described for pregnancy conception in clinical and research settings across the United States and internationally.
...
**Limitations to understand:** This calculator provides population-average estimates. Individual factors including genetics, medications, medical conditions, hydration status, and measurement timing can affect results. For medical decisions, always consult your healthcare provider.`}
        benefits={[
          { title: "Real-Time Pregnancy Conception Calculator results as You Type", text: "Results update the moment you change any input - there's no button to click and no page to reload. This makes the Pregnancy Conception Calculator fast and intuitive, letting you explore dozens of different scenarios in minutes and develop a genuine feel for how each variable affects your outcome." },
          { title: "Pregnancy Conception Calculator methodology and assumptions & Guidelines", text: "The methodology should be interpreted alongside the specific formula and sources described for this calculator; a health result is an estimate and should not be treated as a clinical diagnosis. " },
