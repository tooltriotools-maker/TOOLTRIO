...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Alcohol Calorie Calculator" description="Count calories in your drinks and see how long it takes to burn them off. Beer, wine, spirits, and cocktails." icon="🍷" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="alcohol-calorie-calculator">
