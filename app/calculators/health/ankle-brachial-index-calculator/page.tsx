...
const faqs = [('What is the ankle-brachial index (ABI)?', 'The ABI is a simple, non-invasive test that compares the blood pressure in your ankle to the blood pressure in your arm. A normal ABI is between 0.90 and 1.30. Values below 0.90 indicate narrowing of the arteries in the legs (peripheral artery disease, or PAD), which is caused by atherosclerosis — the same process that causes heart attacks and strokes. PAD affects about 8-10 million Americans and is often undetected because symptoms can be absent or attributed to aging.'), ('What ABI score indicates peripheral artery disease?', 'An ABI below 0.90 is the standard diagnostic threshold for PAD. Mild PAD is 0.70-0.89, moderate PAD is 0.40-0.69, and critical limb ischemia (severe) is below 0.40. An ABI above 1.30 suggests arterial calcification (common in diabetes and kidney disease) — the arteries are too stiff to compress, which can falsely elevate the reading and requires additional testing like toe-brachial index.'), ('Why does PAD increase heart attack and stroke risk?', 'PAD is a form of systemic atherosclerosis — if arteries in your legs are narrowed, the same process is almost certainly occurring in arteries throughout your body including coronary arteries and carotid arteries. People with PAD have a 2-4× higher risk of heart attack, stroke, and cardiovascular death compared to people without PAD, regardless of other risk factors. An ABI below 0.90 is an independent predictor of mortality that adds prognostic information beyond traditional Framingham risk factors.')]
