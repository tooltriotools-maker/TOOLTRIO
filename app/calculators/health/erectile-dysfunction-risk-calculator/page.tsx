...
const faqs = [('How common is erectile dysfunction and who does it affect?', 'ED affects approximately 30 million men in the United States. Prevalence rises sharply with age: approximately 12% of men in their 40s, 22% in their 50s, 30% in their 60s, and over 50% in their 70s. However, ED is not an inevitable consequence of aging — it is strongly associated with modifiable cardiovascular risk factors. ED and cardiovascular disease share the same underlying pathology (endothelial dysfunction and atherosclerosis), and ED is now recognized as a cardiovascular warning sign: men with ED and no known heart disease have a 2-3× higher risk of future cardiovascular events.'), ('What is the link between ED and heart disease?', 'The penile arteries are small-caliber vessels that show atherosclerosis earlier than larger coronary arteries. The Princeton III Consensus recommends that men under 70 with unexplained ED be evaluated for cardiovascular risk. Studies show that men with new-onset ED have a 10-year risk of major cardiovascular events 2× higher than age-matched controls, and ED typically precedes coronary artery disease by 3-5 years — making it an early warning sign. PDE5 inhibitors (sildenafil/Viagra) work by potentiating nitric oxide signaling, the same pathway impaired by endothelial dysfunction in cardiovascular disease.'), ('What lifestyle changes most effectively improve erectile function?', 'The Massachusetts Male Aging Study and subsequent trials identify the most effective interventions: (1) Aerobic exercise — 40 min, 4×/week reduces ED severity by 25-30% in men with moderate ED; (2) Mediterranean diet — associated with 40% lower ED prevalence; (3) Weight loss — 10% body weight reduction in obese men significantly improves erectile function; (4) Smoking cessation — doubles blood flow to penile tissue within months; (5) Reducing alcohol — heavy drinking is both a psychological and physiological suppressant of erectile function; (6) Sleep optimization — testosterone production occurs during REM sleep; (7) Managing depression and anxiety — psychological factors account for 20-30% of ED cases.')]
