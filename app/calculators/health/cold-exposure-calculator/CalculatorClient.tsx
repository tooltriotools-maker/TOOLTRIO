...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Cold Exposure Calculator" description="Calculate the benefits and safe parameters for cold water immersion and ice baths." icon="🧊" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="cold-exposure-calculator">
