...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Intermittent Fasting Calculator" description="Get your personalised fasting schedule with eating window times, calorie targets, and fasting benefits by hour." icon="⏰" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="intermittent-fasting-calculator">
