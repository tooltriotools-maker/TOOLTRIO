...
const faqs = [
  ...
  {question:'Is creatine safe for long-term use?',answer:'Creatine monohydrate is one of the most extensively studied sports supplements. Evidence supports its use in many healthy adults at commonly studied doses, but individual suitability depends on health status, medications, and other factors. Some commonly discussed adverse effects and safety questions have been studied, but evidence does not justify a blanket claim that creatine is risk-free for every person. A comprehensive safety review published in the Journal of the International Society of Sports Nutrition (2017) concluded that 3–5 g/day is a commonly studied maintenance range for healthy adults; people with kidney disease or other relevant conditions should discuss supplementation with a clinician. Creatine slightly raises serum creatinine (a kidney biomarker), which can mislead clinicians — but this can affect interpretation of creatinine-based laboratory results and should be interpreted in clinical context.',},
