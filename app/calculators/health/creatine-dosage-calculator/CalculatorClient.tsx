...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Creatine Dosage Calculator" description="Calculate your optimal creatine monohydrate dose for loading and maintenance based on body weight." icon="💊" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="creatine-dosage-calculator">
