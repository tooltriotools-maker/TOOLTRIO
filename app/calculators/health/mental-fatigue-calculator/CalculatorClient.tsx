...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Mental Fatigue Calculator" description="Score your cognitive load and burnout risk from work hours, sleep debt, stress, and recovery habits." icon="🧠" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="mental-fatigue-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to interpret this mental fatigue calculator</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>This tool uses Daily work hours, Total sleep last 7 nights, Daily screen time, Exercise this week, Social interaction, Mindfulness practice, Fatigue Score to calculate the displayed result. The output reflects the formula implemented on this page and the values you enter.</p>
