...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Ergonomics Score Calculator" description="Score your workstation setup and identify risk factors for repetitive strain injuries." icon="🪑" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="ergonomics-score-calculator">
