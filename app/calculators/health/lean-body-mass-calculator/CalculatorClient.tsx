...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Lean Body Mass Calculator" description="Calculate lean body mass using Boer, James, and Hume formulas. Understand your muscle and fat composition." icon="💪" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="lean-body-mass-calculator">
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600 mb-2">
          Use this Lean Body Mass tool to explore an estimate based on the inputs you provide. Results depend on the assumptions shown and should not be treated as a diagnosis or individualized medical advice. No account is required.
        </p>
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Lean Body Mass Calculator** is a free, health calculator using the method and reference data described for this specific calculator. Get your lean body mass instantly - no account needed, works on all devices.
...
Combine this with [our Body Fat Calculator](/calculators/health/body-fat-calculator), [our Protein Intake Calculator](/calculators/health/protein-intake-calculator) for a complete picture.`}
        howItWorks={`**The science behind the Lean Body Mass Calculator:** This tool applies the calculation method described for lean body mass in clinical and research settings across the United States and internationally.
...
**Limitations to understand:** This calculator provides population-average estimates. Individual factors including genetics, medications, medical conditions, hydration status, and measurement timing can affect results. For medical decisions, always consult your healthcare provider.`}
        benefits={[
          { title: "Real-Time Lean Body Mass Calculator output as You Type", text: "Results update the moment you change any input - there's no button to click and no page to reload. This makes the Lean Body Mass Calculator fast and intuitive, letting you explore dozens of different scenarios in minutes and develop a genuine feel for how each variable affects your outcome." },
          { title: "Lean Body Mass Calculator methodology and assumptions & Guidelines", text: "The methodology should be interpreted alongside the specific formula and sources described for this calculator; a health result is an estimate and should not be treated as a clinical diagnosis. " },
