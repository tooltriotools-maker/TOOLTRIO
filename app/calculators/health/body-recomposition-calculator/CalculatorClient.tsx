...
<InputField label="Age" value={age} onChange={setAge} min={15} max={90} step={1} suffix="yrs" />
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600 mb-2">
          Use this Body Recomposition tool to explore an estimate based on the inputs you provide. Results depend on the assumptions shown and should not be treated as a diagnosis or individualized medical advice. No account is required.
        </p>
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Body Recomposition Calculator** is a a health information tool using the method and reference data described for this calculator. Get your body recomposition instantly - no account needed, works on all devices.
...
Combine this with [our TDEE Calculator](/calculators/health/tdee-calculator), [our Macro Calculator](/calculators/health/macro-calculator) for a complete picture.`}
        howItWorks={`**The science behind the Body Recomposition Calculator:** This tool applies the calculation method described for body recomposition in clinical and research settings across the United States and internationally.
...
**Limitations to understand:** This calculator provides population-average estimates. Individual factors including genetics, medications, medical conditions, hydration status, and measurement timing can affect results. For medical decisions, always consult your healthcare provider.`}
        benefits={[
          ...
          { title: "Body Recomposition Calculator methodology and assumptions & Guidelines", text: "The methodology should be interpreted alongside the specific formula and sources described for this calculator; a health result is an estimate and should not be treated as a clinical diagnosis. " },
