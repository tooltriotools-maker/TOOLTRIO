...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Gratitude Health Calculator" description="Measure your gratitude practice and estimate its impact on mental wellbeing and resilience." icon="🙏" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="gratitude-health-calculator">
