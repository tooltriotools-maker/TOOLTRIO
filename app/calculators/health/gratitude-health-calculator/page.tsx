...
Gratitude practice is most useful as one component of a broader mental wellness approach. Use [our Mental Health Score Calculator](/calculators/health/mental-health-score-calculator) for a more comprehensive assessment of your psychological wellbeing.`,
  comparisonTable: [],
  didYouKnow: [],
  keyStats: [],
  mistakesDetailed: [],
