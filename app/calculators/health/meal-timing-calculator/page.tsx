...
const seoContent = {
  healthSourceProfile: 'meal-timing-calculator',
...
`,
  howItWorks: `This calculator uses the method documented for this specific calculator to estimate meal timing from your inputs. Where multiple validated methods exist, the approach with the strongest evidence base for the general adult population is used as the primary result.
