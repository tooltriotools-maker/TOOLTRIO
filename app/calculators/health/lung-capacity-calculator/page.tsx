...
const faqs = [
  ...
  {"question": "Can lung capacity be improved?", "answer": "For healthy adults, aerobic exercise consistently improves respiratory muscle endurance and efficiency but does not meaningfully increase lung volume beyond genetic limits. However, for people with COPD or asthma, pulmonary rehabilitation programs (supervised exercise plus breathing techniques) produce clinically significant improvements in exercise tolerance, quality of life, and hospitalization rates. Inspiratory Muscle Training (IMT) devices, used 30 minutes/day, improve inspiratory muscle strength by 30-40% in patients with respiratory muscle weakness. Quitting smoking is the only intervention supported by the cited methodology or source where applicable to slow the rate of FEV1 decline."}
]
...
export default function Page() {
  ...
  return (
    <>
      ...
      />
          <CalculatorBatch45DeepDive slug="lung-capacity-calculator" />
</>
  )
}
