...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Lung Capacity Calculator" description="Compare your measured FVC and FEV1 to predicted values and identify obstructive or restrictive spirometry patterns." icon="🫁" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="lung-capacity-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to interpret this lung capacity calculator</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>This tool uses Age, Height, Measured FVC (L), Measured FEV1 (L), Smoking Pack-Years, FVC %, FEV1 % to calculate the displayed result. The output reflects the formula implemented on this page and the values you enter.</p>
