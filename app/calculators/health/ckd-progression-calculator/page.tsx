...
const faqs = [
  {"question": "What is a normal eGFR decline rate?", "answer": "Normal age-related eGFR decline is approximately 0.5–1.0 mL/min/1.73m² per year after age 40. In people with CKD, annual decline ranges widely — from 1–2 mL/min/year (slow progressors who may never reach dialysis) to over 5–10 mL/min/year (rapid progressors). The CKD-REIN study found proteinuria, blood pressure, and diabetes status are the strongest predictors of progression rate. An eGFR decline of more than 5 mL/min/1.73m² in one year warrants urgent nephrology evaluation."},
  {"question": "How does proteinuria affect kidney disease progression?", "answer": "Proteinuria (protein in urine) is both a marker and a cause of kidney damage. Even microalbuminuria (30–300 mg/day) doubles CKD progression risk. Overt proteinuria above 300 mg/day increases progression risk 5-10×. Mechanically, the protein itself is toxic to tubular cells as it passes through the filtration barrier. ACE inhibitors and ARBs reduce proteinuria by 40–50% and slow progression independently of their blood pressure effect — they are first-line therapy for any CKD with proteinuria, regardless of blood pressure."},
  {"question": "What lifestyle changes slow CKD progression?", "answer": "The most evidence-backed interventions: (1) Blood pressure control to < 130/80 mmHg (especially with proteinuria) — slows progression 20–30%; (2) ACE inhibitor or ARB if proteinuria present — slows progression 25–35%; (3) SGLT2 inhibitors (dapagliflozin, empagliflozin) now have Level 1A evidence for CKD progression reduction regardless of diabetes; (4) Smoking cessation; (5) Protein restriction to 0.6–0.8 g/kg/day in stage 4–5; (6) NSAID avoidance; (7) Weight loss in obesity. The combination of optimal BP + ACE/ARB + SGLT2i can reduce progression by over 40%."}
]
