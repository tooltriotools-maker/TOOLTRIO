...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Vitamin D Calculator" description="Calculate your vitamin D needs from sunlight and supplements based on your skin type, location, and season." icon="☀️" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="vitamin-d-calculator">
