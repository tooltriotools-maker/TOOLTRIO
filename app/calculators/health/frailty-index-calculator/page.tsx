...
const faqs = [('What is the Fried Frailty Phenotype?', 'The Fried Frailty Phenotype, published by Dr. Linda Fried and colleagues in 2001, is the most widely used clinical tool for assessing frailty in older adults. It identifies frailty based on five criteria: (1) Unintentional weight loss of 10+ lbs in the past year, (2) Self-reported exhaustion most of the time, (3) Slow walking speed (>7 seconds for 15 feet), (4) Weak grip strength (below sex and BMI-adjusted thresholds), (5) Low physical activity (< 383 kcal/week for men, < 270 kcal/week for women). Meeting 3+ criteria = frail; 1-2 = pre-frail; 0 = robust.'), ('Is frailty reversible?', 'Pre-frailty is strongly reversible with targeted intervention. Research shows that exercise programs — particularly combining resistance training with balance exercises — can move people from pre-frail to robust in 3-6 months. Nutritional interventions (adequate protein, vitamin D, B12) are effective complementary approaches. Even in established frailty, exercise reduces fall risk and hospitalization rates. The critical insight is that frailty is not an inevitable consequence of aging but a syndrome with modifiable drivers.'), ('How does frailty affect health outcomes?', 'Frail adults (3+ Fried criteria) have dramatically worse health outcomes: 3-5× higher risk of hospitalization, 2-3× higher 3-year mortality, significantly higher rates of disability, falls, and poor surgical outcomes. Even pre-frailty (1-2 criteria) doubles adverse outcomes compared to robust older adults. This is why identifying pre-frailty is so clinically valuable — it is the optimal intervention window before the syndrome becomes established.')]
