...
const faqs = [
  ...
  {"question": "How does frailty affect health outcomes?", "answer": "Frail adults (3+ Fried criteria) have dramatically worse health outcomes: 3-5× higher risk of hospitalization, 2-3× higher 3-year mortality, significantly higher rates of disability, falls, and poor surgical outcomes. Even pre-frailty (1-2 criteria) doubles adverse outcomes compared to robust older adults. This is why identifying pre-frailty is so clinically valuable — it is the optimal intervention window before the syndrome becomes established."}
]
