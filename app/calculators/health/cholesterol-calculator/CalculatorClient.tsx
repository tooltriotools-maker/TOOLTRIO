...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Cholesterol Calculator" description="Check your lipid panel against AHA guidelines. Calculate LDL using the Friedewald equation and assess cardiovascular risk." icon="🫀" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="cholesterol-calculator">
