...
export default function Page() {
  ...
  return (
    <>
      ...
      />
          <CalculatorBatch45DeepDive slug="heart-rate-variability-calculator" />
</>
  )
}
