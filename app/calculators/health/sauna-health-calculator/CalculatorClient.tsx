...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Sauna Health Benefits Calculator" description="Score your sauna routine for cardiovascular, longevity, and recovery benefits based on the Kuopio Heart Study data." icon="🔥" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="sauna-health-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the sauna health calculator result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>Review the calculated output together with Sessions per week, Duration per session, Temperature, Years using sauna, Benefit Score, Safety. The result reflects the values entered and the calculation implemented by this tool.</p>
