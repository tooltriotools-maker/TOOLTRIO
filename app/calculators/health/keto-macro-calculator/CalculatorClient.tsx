...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Keto Macro Calculator" description="Get your exact ketogenic diet macros: net carbs, protein, and fat for standard, targeted, or high-protein keto." icon="🥩" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="keto-macro-calculator">
