...
const faqs = [('How do I calculate how many calories I need per day?', 'Your daily calorie needs equal your Basal Metabolic Rate (BMR) multiplied by an activity factor. BMR is calculated from your weight, height, age, and sex using the Mifflin-St Jeor equation — the most validated formula for general adults. The activity multiplier ranges from 1.2 (sedentary) to 1.9 (very hard training). For weight loss, subtract 300-500 calories from your TDEE. For weight gain (muscle building), add 250-300 calories. Never eat below your BMR for extended periods.'), ('What is a safe calorie deficit for weight loss?', 'A deficit of 300-500 calories below your TDEE produces weight loss of approximately 0.5-1 lb per week, which is the clinically recommended rate for sustainable fat loss. Deficits larger than 750 calories per day increase the risk of muscle loss, nutrient deficiencies, fatigue, and metabolic adaptation (where your body reduces its metabolic rate). The minimum calorie floor — eating below which is rarely safe — is your BMR: the calories needed to run your organs at rest.'), ('How much protein do I need when losing weight?', 'Research consistently shows that higher protein intake (1.6-2.2 g per kg body weight per day) during a calorie deficit preserves muscle mass, increases satiety, and modestly boosts the thermic effect of food. At 1.6 g/kg for a 75kg person, that is 120 grams of protein per day. Spreading protein across 3-4 meals (30-40g each) is more effective for muscle protein synthesis than consuming most protein in one meal.')]
