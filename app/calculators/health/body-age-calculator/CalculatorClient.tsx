...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Body Age Calculator" description="Estimate your biological body age based on lifestyle factors like exercise, sleep, BMI, and stress." icon="🔬" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="body-age-calculator">
