...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Skin Aging Risk Calculator" description="Calculate your skin's biological age and the top accelerators of premature aging based on UV, lifestyle, and skincare routine." icon="✨" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="skin-aging-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the skin aging calculator result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>Review the calculated output together with Age, Daily UV Exposure, Smoking history, Daily sugar intake, Sleep, Water intake. The result reflects the values entered and the calculation implemented by this tool.</p>
