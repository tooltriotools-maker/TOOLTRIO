...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Push-Up Calculator" description="Get your push-up fitness score and a personalised 4-week training plan to hit your goal." icon="💪" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="pushup-calculator">
