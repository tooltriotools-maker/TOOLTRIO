...
const faqs = [('What does my DEXA T-score mean?', 'The T-score compares your bone density to a reference population of healthy young adults (30-year-old same sex). A T-score of 0 means your bone density is exactly average for a young adult. T-score of -1.0 means 1 standard deviation below peak bone mass. WHO classification: T-score ≥ -1.0 = Normal; -1.0 to -2.5 = Osteopenia (low bone mass); ≤ -2.5 = Osteoporosis; ≤ -2.5 with fragility fracture = Severe osteoporosis. Each standard deviation decrease in T-score approximately doubles fracture risk.'), ('What is the difference between T-score and Z-score?', 'The T-score compares your bone density to peak young adult bone mass and is used for fracture risk prediction. The Z-score compares your bone density to people your own age and sex — it indicates whether your bone loss is faster or slower than expected for your age. A Z-score below -2.0 means your bone density is significantly below what is expected for your age, suggesting a secondary cause (medication, disease) rather than just age-related bone loss. Post-menopausal women and men over 50 are assessed with T-scores; younger adults use Z-scores.'), ('What is the 10-year fracture risk (FRAX)?', 'FRAX (Fracture Risk Assessment Tool) calculates the 10-year probability of a major osteoporotic fracture (hip, spine, wrist, shoulder) based on T-score plus clinical risk factors. Treatment thresholds: US guidelines recommend pharmacological treatment when 10-year hip fracture risk ≥ 3% or major osteoporotic fracture risk ≥ 20%. First-line treatments are bisphosphonates (alendronate, risedronate), which reduce fracture risk by 30-50%. Weight-bearing exercise and calcium/vitamin D supplementation are foundational at all stages.')]
