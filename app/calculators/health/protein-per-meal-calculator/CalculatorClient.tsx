...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Protein Per Meal Calculator" description="Find the optimal protein dose per meal to maximise muscle protein synthesis based on body weight and goals." icon="🥩" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="protein-per-meal-calculator">
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Protein Per Meal Calculator** is a a health information tool using the method and reference data described for this calculator. Get your protein per meal instantly - no account needed, works on all devices.
...
Combine this with [our BMI Calculator](/calculators/health/bmi-calculator), [our Calorie Calculator](/calculators/health/calorie-calculator) for a complete picture.`}
        howItWorks={`**The science behind the Protein Per Meal Calculator:** This tool applies the calculation method described for protein per meal in clinical and research settings across the United States and internationally.
...
**Limitations to understand:** This calculator provides population-average estimates. Individual factors including genetics, medications, medical conditions, hydration status, and measurement timing can affect results. For medical decisions, always consult your healthcare provider.`}
        benefits={[
          { title: "Real-Time Protein Per Meal Calculator output as You Type", text: "Results update the moment you change any input - there's no button to click and no page to reload. This makes the Protein Per Meal Calculator fast and intuitive, letting you explore dozens of different scenarios in minutes and develop a genuine feel for how each variable affects your outcome." },
          { title: "Protein Per Meal Calculator methodology and assumptions & Guidelines", text: "The methodology should be interpreted alongside the specific formula and sources described for this calculator; a health result is an estimate and should not be treated as a clinical diagnosis. " },
