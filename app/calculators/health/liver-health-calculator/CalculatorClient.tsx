...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Liver Health Calculator" description="Assess your liver health risk based on lifestyle factors including alcohol, diet, and BMI." icon="🫀" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="liver-health-calculator">
