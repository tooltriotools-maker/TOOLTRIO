...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Body Surface Area Calculator" description="Calculate BSA using Mosteller, DuBois, Haycock, and Boyd formulas for drug dosing and clinical applications." icon="📐" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="body-surface-area-calculator">
