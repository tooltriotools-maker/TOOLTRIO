...
const faqs = [('What is a normal cardiac output?', 'Cardiac output (CO) = Heart Rate × Stroke Volume, expressed in litres per minute (L/min). Normal resting CO is 4–8 L/min for adults. More meaningful is cardiac index (CI = CO ÷ Body Surface Area), with normal range 2.5–4.0 L/min/m². The heart pumps approximately 5 litres of blood per minute at rest — your entire blood volume — and can increase 4-6× during maximal exercise in trained athletes. CO below 4 L/min at rest may indicate reduced cardiac function; above 8 L/min at rest may indicate high-output states like anaemia, sepsis, or hyperthyroidism.'), ('What is mean arterial pressure (MAP)?', 'MAP = Diastolic BP + (Pulse Pressure ÷ 3). It represents the average pressure driving blood to organs throughout the cardiac cycle. Normal MAP is 70–100 mmHg. A MAP below 65 mmHg is used as the threshold for organ perfusion failure in critical care (septic shock protocol). MAP is more physiologically meaningful than systolic BP alone because it accounts for the entire cardiac cycle — organs experience MAP continuously, not just peak systolic pressure.'), ('What is the Rate-Pressure Product (RPP)?', 'The Rate-Pressure Product = Heart Rate × Systolic BP, and estimates myocardial oxygen consumption. RPP above 20,000–25,000 mm Hg/min typically marks the ischaemic threshold in people with coronary artery disease — the point where myocardial oxygen demand exceeds supply and angina may occur. This is why both tachycardia and hypertension individually increase cardiac workload, and why their combination is particularly dangerous for people with coronary disease.')]
