...
const faqs = [
  {"question": "What is the Numeric Rating Scale (NRS) for pain?", "answer": "The Numeric Rating Scale (0-10) is the most widely used clinical pain assessment tool because of its simplicity and reliability. Score meanings: 0 = no pain; 1-3 = mild (does not interfere with activities); 4-6 = moderate (interferes with but does not stop most activities); 7-9 = severe (prevents many activities); 10 = worst imaginable pain. Research shows that a score of 4 or above consistently predicts functional impairment and is a common threshold for initiating or escalating treatment. This calculator uses a composite score combining NRS with frequency, sleep, and activity impact for a more complete picture."},
  {"question": "When does pain become chronic?", "answer": "Pain is classified as chronic when it persists beyond the normal healing time — typically more than 3 months — or when it is associated with a chronic disease process. The International Association for the Study of Pain (IASP) 2019 classification distinguishes chronic primary pain (pain as a condition itself, like fibromyalgia or complex regional pain syndrome) from chronic secondary pain (pain due to an identifiable cause like arthritis, cancer, or nerve damage). Approximately 20% of US adults (50 million people) live with chronic pain, and 8% have high-impact chronic pain that limits daily life."},
  {"question": "What is multimodal pain management?", "answer": "Multimodal pain management combines two or more treatments with different mechanisms to achieve better pain control with lower doses of any single agent. A comprehensive multimodal program typically includes: pharmacological (analgesics, anti-inflammatories, nerve medications), physical (physical therapy, TENS, exercise), psychological (CBT, acceptance-based therapy — reduces pain catastrophizing), interventional (nerve blocks, injections) for appropriate cases, and lifestyle (sleep optimization, anti-inflammatory diet, stress management). Research shows multimodal approaches outperform single-modality treatment, particularly for chronic pain."}
]
...
export default function Page() {
  ...
  return (
    <>
      ...
      />
          <CalculatorBatch46DeepDive slug="pain-score-calculator" />
</>
  )
}
