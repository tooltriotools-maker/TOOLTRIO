...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Caffeine Half-Life Calculator" description="Find out when caffeine clears your system and the best time to stop drinking coffee for quality sleep." icon="☕" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="caffeine-half-life-calculator">
