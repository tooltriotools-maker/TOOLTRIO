...
const faqs = [
  {"question": "What is metabolic age?", "answer": "Metabolic age compares your Basal Metabolic Rate (BMR) to the average BMR of people at various chronological ages. If your BMR matches what is typical for a 35-year-old but you are 45, your metabolic age is 35. A younger metabolic age indicates a healthier, more efficient metabolism — typically reflecting greater lean muscle mass, better cardiovascular fitness, lower body fat percentage, and better metabolic health markers. Unlike biological age (which measures cellular aging), metabolic age specifically captures cardiometabolic fitness."},
  {"question": "What factors increase metabolic age?", "answer": "The main drivers of elevated metabolic age are: excess body fat (especially visceral/abdominal fat), muscle loss from inactivity (sarcopenia), high resting heart rate from poor cardiovascular fitness, sedentary lifestyle, poor sleep quality, chronic stress (elevates cortisol which promotes fat storage and muscle breakdown), and high sugar intake (drives insulin resistance and glycation). The encouraging finding from research is that most of these factors are highly responsive to lifestyle changes — metabolic age can measurably improve within 8-12 weeks of consistent exercise and dietary improvement."},
  {"question": "How can I lower my metabolic age?", "answer": "The most effective strategies to reduce metabolic age are: (1) Resistance training 3-4×/week to preserve and build lean muscle mass (muscle is the primary driver of a high BMR); (2) Consistent cardiovascular exercise to lower resting heart rate and improve cardiorespiratory fitness; (3) Reducing processed carbohydrates and added sugar to improve insulin sensitivity; (4) High protein intake (1.6+ g/kg/day) to support muscle synthesis; (5) Prioritizing 7-9 hours of sleep (poor sleep acutely increases cortisol, causing fat storage and muscle breakdown); (6) Reducing waist circumference through diet — central fat is the most metabolically harmful depot."}
]
...
export default function Page() {
  ...
  return (
    <>
      ...
      />
          <CalculatorBatch48DeepDive slug="metabolic-age-calculator" />
</>
  )
}
