...
const faqs = [('What is forward head posture and why is it harmful?', 'Forward head posture (FHP) occurs when the head is positioned in front of the shoulders rather than directly above. For every centimeter the head protrudes forward, the effective weight on the cervical spine increases by approximately 4.5 kg. A head that protrudes 5 cm forward (common in smartphone users) exerts the equivalent of 22 kg of force on cervical vertebrae — compared to the normal 4.5 kg in neutral alignment. Long-term FHP causes chronic neck and upper back pain, reduced lung capacity (the thoracic cavity is compressed), headaches, shoulder impingement, and temporomandibular joint dysfunction.'), ('How many hours of sitting is too much for posture?', "Epidemiological research shows that sitting more than 8 hours per day is independently associated with musculoskeletal problems regardless of exercise habits outside work. The concept of 'active couch potato' describes people who exercise 30 minutes daily but sit 10+ hours — and have similar metabolic and postural risks as truly sedentary people. Current recommendations are to stand or move for at least 2 minutes every 30-45 minutes of sitting. Sit-stand desks reduce lumbar disc pressure and improve postural muscle endurance significantly compared to static sitting, but must be used correctly (proper desk height, avoiding prolonged static standing)."), ('Can posture be corrected in adults?', 'Yes — postural deviations are largely correctable in adults, though it requires consistent, targeted effort. Forward head posture and rounded shoulders respond well to: deep cervical flexor exercises (chin tucks), posterior shoulder stretching, thoracic spine extension mobility work, and strengthening of the lower trapezius and serratus anterior. Research shows measurable structural improvements within 4-8 weeks of daily targeted exercise. The key principle is addressing both the tight/shortened muscles (anterior chest, hip flexors, upper trapezius) and the weak/lengthened muscles (deep cervical flexors, rhomboids, glutes) on both sides of the dysfunction.')]
