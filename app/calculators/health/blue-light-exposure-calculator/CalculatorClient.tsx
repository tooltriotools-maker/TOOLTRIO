...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Blue Light Exposure Calculator" description="Estimate your daily blue light exposure from screens and its impact on sleep and eye health." icon="💙" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug}>
