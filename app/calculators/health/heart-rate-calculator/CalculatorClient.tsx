...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent}: Props) {
  ...
  return (
    <CalculatorLayout title="Heart Rate Calculator" description="Calculate your max heart rate, target zones, and resting HR health status for effective training." icon="💓" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="heart-rate-calculator">
