...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="BMI for Children Calculator" description="Calculate BMI for children aged 2-19 using age and gender-appropriate growth standards." icon="👶" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="bmi-for-children-calculator">
