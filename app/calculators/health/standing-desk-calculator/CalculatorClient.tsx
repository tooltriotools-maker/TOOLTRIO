...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Standing Desk Calculator" description="Calculate the health and calorie benefits of using a standing desk compared to sitting all day." icon="🪑" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="standing-desk-calculator">
