...
const seoContent = {
  healthSourceProfile: 'calcium-calculator',
...
Calcium supplementation should not exceed dietary needs. Large-dose calcium supplementation (1,000+ mg) may increase cardiovascular risk according to some but not all meta-analyses — a conservative approach is to meet nutritional needs primarily through food when practical, with supplements only making up genuine dietary gaps.`,
