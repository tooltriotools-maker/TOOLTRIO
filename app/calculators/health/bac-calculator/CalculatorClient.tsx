...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="BAC Calculator" description="Estimate blood alcohol content by weight, gender, drinks, and time. For education only - never drink and drive." icon="🍺" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug}>
