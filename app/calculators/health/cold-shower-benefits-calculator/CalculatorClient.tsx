...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Cold Shower Benefits Calculator" description="Estimate the mental and physical health benefits of a regular cold shower routine." icon="🚿" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="cold-shower-benefits-calculator">
