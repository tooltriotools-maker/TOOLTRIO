...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Plank Time Calculator" description="Assess core strength via plank hold time percentile and get progressive training targets." icon="🏋️" category="Health" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="plank-time-calculator">
