...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug, seoContent }: Props) {
  ...
  return (
    <CalculatorLayout title="Breastfeeding Calorie Calculator" description="Calculate your personalised health score and get actionable recommendations based on your individual data." icon="🤱" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug}>
...
<InputField label="Age" value={age} onChange={setAge} min={15} max={90} step={1} suffix="yrs" />
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Breastfeeding [Calorie Calculator](/calculators/health/calorie-calculator)** is a free, evidence-based health assessment tool using formulas validated by the CDC, NIH, American Heart Association (AHA), and Academy of Nutrition and Dietetics. Get your breastfeeding calorie instantly - no account needed, works on all devices.
...
**Supports US customary AND metric units:** Enter your measurements in pounds and inches (the American way) or kilograms and centimeters - the calculator handles both instantly. Results include comparison to healthy ranges for your age and gender based on US population norms.`}
        howItWorks={`**The science behind the Breastfeeding Calorie Calculator:** This tool uses peer-reviewed, scientifically validated formulas that are the current gold standard for calculating breastfeeding calorie in clinical and research settings across the United States and internationally.
