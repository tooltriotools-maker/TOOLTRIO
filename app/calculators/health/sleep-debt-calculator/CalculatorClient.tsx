...
const auditFaqs = [
  {"question": "What should I check before using the Sleep Debt Calculator?", "answer": "Check Sleep target (hrs/night), Sleep Debt, Avg Sleep, Days to Recover, Target and make sure each value uses the unit or format requested by the calculator. The result is based on the values you enter."},
  {"question": "How should I interpret the Sleep Debt Calculator result?", "answer": "Read the result together with the inputs and assumptions shown on the page. It is a calculator output for informational use and is not a diagnosis or a substitute for evaluation by a qualified healthcare professional."},
  {"question": "How can I compare different Sleep Debt Calculator scenarios?", "answer": "Change one input at a time while keeping the other values unchanged. Comparing results this way makes it easier to see which input is responsible for the difference."}
];
...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Sleep Debt Accumulation Calculator" description="Track your weekly sleep deficit, calculate cognitive impairment level, and find out how many recovery nights you need." icon="😴" category="Health" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="sleep-debt-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding this sleep debt calculator</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>This calculator uses Sleep target (hrs/night), Sleep Debt, Avg Sleep, Days to Recover, Target. The displayed result is generated from the tool&apos;s implemented formula and the values entered.</p>
