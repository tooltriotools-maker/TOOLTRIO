  ...
  return (
    <CalculatorLayout title="Jet Lag Calculator" description="Calculate jet lag severity and recovery time based on time zones crossed and travel direction." icon="✈️" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="jet-lag-calculator">
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Jet Lag Calculator** is a free, evidence-based health assessment tool using formulas validated by the CDC, NIH, American Heart Association (AHA), and Academy of Nutrition and Dietetics. Get your jet lag instantly - no account needed, works on all devices.
...
Combine this with [our BMI Calculator](/calculators/health/bmi-calculator), [our Calorie Calculator](/calculators/health/calorie-calculator) for a complete picture.`}
        howItWorks={`**The science behind the Jet Lag Calculator:** This tool uses peer-reviewed, scientifically validated formulas that are the current gold standard for calculating jet lag in clinical and research settings across the United States and internationally.
