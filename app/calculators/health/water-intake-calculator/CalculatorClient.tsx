...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug, seoContent}: Props) {
  ...
  return (
    <CalculatorLayout title="Water Intake Calculator" description="Find your daily water intake needs based on weight, activity level, and climate. Get a personalized hydration schedule." icon="💧" category="Health" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="water-intake-calculator">
