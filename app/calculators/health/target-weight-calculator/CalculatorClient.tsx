...
<InputField label={`Current Weight (${unit==='metric'?'kg':'lbs'})`} value={currentWeight} onChange={setCurrentWeight} min={unit==='metric'?30:66} max={unit==='metric'?300:660} step={0.5} suffix={unit==='metric'?'kg':'lbs'} />
      ...
      <SEOContent
        ...
        category="health"
        intro={`The **Target Weight Calculator** is a a health information tool using the method and reference data described for this calculator. Get your target weight instantly - no account needed, works on all devices.
...
Combine this with [our BMI Calculator](/calculators/health/bmi-calculator), [our Calorie Calculator](/calculators/health/calorie-calculator) for a complete picture.`}
        howItWorks={`**The science behind the Target Weight Calculator:** This tool applies the calculation method described for target weight in clinical and research settings across the United States and internationally.
...
**Limitations to understand:** This calculator provides population-average estimates. Individual factors including genetics, medications, medical conditions, hydration status, and measurement timing can affect results. For medical decisions, always consult your healthcare provider.`}
        benefits={[
          ...
          { title: "Target Weight Calculator methodology and assumptions & Guidelines", text: "The methodology should be interpreted alongside the specific formula and sources described for this calculator; a health result is an estimate and should not be treated as a clinical diagnosis. " },
