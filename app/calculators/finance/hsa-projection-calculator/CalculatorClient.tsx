      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          {result?(<>
            ...
            <Card><h2 className="text-lg font-black text-gray-900 mb-2">🏥 HSA Investment Projection Calculator USA 2026</h2><p className="text-sm text-gray-600">Project your HSA balance to retirement — investing rather than spending creates a useful medical savings reserve that grows completely tax-free.</p></Card>
