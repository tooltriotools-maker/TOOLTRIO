...
export default function Page() {
 return <>
      ...
      <CalculatorClient faqs={faqs} structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug="emi-calculator-complete-guide-understand-home-car-personal-loans" />
    </>
}
