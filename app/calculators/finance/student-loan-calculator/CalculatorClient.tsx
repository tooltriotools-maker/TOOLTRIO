...
Federal and private student loans can have materially different repayment, relief, forgiveness and servicing terms. This calculator intentionally models only the amortization math; check the current federal options on StudentAid.gov before making a repayment or refinancing decision.
...
PSLF and other federal forgiveness programs have detailed eligibility and payment-history requirements. This calculator does not determine eligibility or projected forgiveness.`}
        benefits={[
        ...
        tipsSection={`For borrowers with significant federal debt: run a comparison between standard 10-year repayment and income-driven repayment specifically for your career path and expected income trajectory. If you are considering IDR or PSLF, verify the currently available plan and your qualifying-payment history through StudentAid.gov or your servicer before changing payments.
