...
export default function Page() { return <>
      ...
      <CalculatorClient faqs={faqs} structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug="uk-stamp-duty-guide-sdlt-first-time-buyer-buy-to-let-2026" />
    </> }
