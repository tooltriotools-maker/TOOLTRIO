...
const faqs = [
  ...
  { question: 'How do I use CAGR to calculate a future investment target?', answer: 'Rearrange the CAGR formula to solve for future value: Future Value = Present Value × (1 + CAGR)^Years. Example: you have $50,000 today and want to know what it\'s worth at 8% CAGR after 20 years: $50,000 × (1.08)^20 = $50,000 × 4.661 = $233,048. To solve for the required CAGR: if you need $500,000 in 15 years from $100,000: CAGR = (500,000/100,000)^(1/15) - 1 = 5^0.0667 - 1 = 11.6%. You need 11.6% CAGR — realistic for a diversified equity portfolio over 15 years but above returns offered by lower-risk savings products.' }
]
