    ...
    <CalculatorLayout title="Rent vs Buy Calculator USA 2026" description="Compare the complete 10-year financial outcome of renting vs buying a home in your area." icon="🏠" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="rent-vs-buy-calculator">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className={`rounded-2xl border p-5 ${buyBetter ? 'bg-green-50 border-green-200' : 'bg-blue-50 border-blue-200'}`}>
            <div className="flex items-center justify-between flex-wrap gap-3">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-black text-gray-900" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>{fmt(result.monthlyMortgage)}</p>
        ...
        <div className="rounded-3xl border p-6 md:p-8" style={{background:'rgba(255,255,255,0.82)',backdropFilter:'blur(12px)',borderColor:'rgba(226,232,240,0.7)',boxShadow:'0 8px 30px rgba(15,23,42,0.06)'}}>
          <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-6" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>Rent vs Buy: Complete Guide</h2>
