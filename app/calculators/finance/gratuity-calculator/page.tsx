...
export const metadata: Metadata = generateCalculatorMetadata({
 ...
 description: 'Free gratuity and severance pay calculator USA 2026. Estimate end-of-service gratuity, severance benefits, and final settlement amounts based on years of.',
