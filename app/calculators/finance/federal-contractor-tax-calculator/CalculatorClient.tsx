...
export default function CalculatorClient({faqs,structuredData,relatedCalculators}:Props){
  ...
  return(
    <CalculatorLayout title="Federal Contractor Tax Calculator USA 2026" description="Estimate a Virginia 1099 federal-contractor scenario after business expenses, self-employment tax, a simplified federal income-tax estimate and retirement contributions." icon="🏛️" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="federal-contractor-tax-calculator">
