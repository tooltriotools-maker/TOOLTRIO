...
const faqs = [
  ...
  { question: 'What is the best way to save for multiple goals simultaneously?', answer: 'Assign each goal a monthly dollar amount proportional to its priority and timeline. Use separate named accounts for each goal — most online banks allow multiple savings buckets within one account (Ally Bank, Marcus, etc.). Automate transfers for each goal on payday before discretionary spending occurs. Priority order for competing goals: (1) employer 401k match — always (stated return under the applicable terms); (2) minimum emergency fund ($1,000-$2,000); (3) high-interest debt payoff; (4) goal-specific savings in parallel; (5) full emergency fund expansion. Don\'t try to pursue all goals equally — some have mathematical priority over others because of stated return under the applicable termss from match capture or guaranteed costs avoided from debt payoff.' },
