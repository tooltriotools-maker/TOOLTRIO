...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Treasury Bill (T-Bill) Calculator USA 2026" description="Calculate T-Bill purchase price, bond equivalent yield, annualized return, and state tax exemption benefit." icon="🏦" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="treasury-bill-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to use and interpret this treasury bill calculator</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>This calculator uses Purchase Price, Interest Earned, Bond Equiv. Yield, Annualized Return to produce the results displayed above. Change one input at a time when comparing scenarios so you can see which assumption is responsible for the difference.</p>
