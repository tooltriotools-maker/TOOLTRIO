...
const faqs = [
  ...
  { question: 'Does crossing $34,000 mean exactly 85% of my benefits are taxable?', answer: 'No. For a single filer, income above $34,000 can make up to 85% of benefits taxable, but the estimated taxable amount comes from the IRS worksheet. This calculator uses a simplified band classification.' },
