...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="UK Fixed Rate vs Tracker Mortgage Calculator 2026" description="Compare 2-year, 5-year fixed rate vs BOE tracker mortgages on total cost and rate risk." icon="🏠" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug}>
