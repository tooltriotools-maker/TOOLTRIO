...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="SIP vs FD Calculator India 2026" description="Compare monthly SIP mutual fund returns vs Fixed Deposit after tax over 3–20 years." icon="⚖️" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="sip-vs-fd-calculator">
