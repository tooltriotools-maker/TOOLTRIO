...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="UK Pension Drawdown vs Annuity Calculator 2026" description="Compare flexible pension drawdown vs guaranteed annuity for UK retirees." icon="💷" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="uk-pension-drawdown-vs-annuity-calculator">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-3xl border p-6 md:p-8" style={{background:'rgba(255,255,255,0.82)',backdropFilter:'blur(12px)',borderColor:'rgba(226,232,240,0.7)',boxShadow:'0 8px 30px rgba(15,23,42,0.06)'}}>
          <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-6" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>Uk Pension Drawdown vs Annuity: Complete Guide</h2>
      ...
      <Card className="mt-6">
        <h2 className="text-lg font-black text-gray-900 mb-3">
          UK Pension Drawdown Vs Annuity Calculator Example (2026)
        </h2>
        ...
        <p className="text-sm text-gray-600">
          This UK Pension Drawdown Vs Annuity 2026 tool helps you model claiming strategies and determine the optimal age to start benefits based on your situation.
        </p>
      </Card>
