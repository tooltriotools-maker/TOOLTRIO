    ...
    >
      ...
      <div className="mt-8">
        <SEOContent
          ...
          benefits={[{title:"2026 contribution cap",text:"The calculation will not exceed the $72,000 2026 SEP contribution ceiling."},{title:"Owner estimate",text:"See the calculator's simplified contribution estimate for the entered self-employment income."},{title:"Growth illustration",text:"Project one modeled contribution for 30 years at 7%; this is does not promise future investment performance."}]}
          useCases={[
