...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="SEP IRA vs Solo 401k Calculator USA 2026" description="Compare contribution limits, tax deductions, and wealth building for self-employed retirement accounts." icon="👔" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="sep-ira-vs-solo-401k-calculator">
