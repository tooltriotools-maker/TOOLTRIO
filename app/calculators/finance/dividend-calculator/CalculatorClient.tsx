...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Dividend Income Calculator USA 2026" description="Calculate annual dividend income, yield on cost growth, and DRIP compounding projections." icon="💰" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="dividend-calculator">
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600 leading-relaxed">
            ...
            <div>
              ...
              <p>Qualified dividends from US stocks held for more than 60 days during the applicable 121-day period are taxed at favorable rates: 0% (income within the 2026 0% qualified-dividend threshold for your filing status), 15% (most middle-income taxpayers), 20% (high earners). Non-qualified dividends (REITs, some foreign stocks, ETFs with bonds) are taxed as ordinary income up to 37%. Strategy: hold REITs and bond funds in tax-advantaged accounts (IRA, 401k) where dividend taxation does not apply. Hold qualified dividend stocks in taxable accounts for the favorable 15% rate. In a Roth IRA, all dividends are completely tax-free.</p>
