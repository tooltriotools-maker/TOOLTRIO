...
const faqs: {question:string;answer:string}[] = [
  ...
  { question: 'Does my state limit garnishment below the federal 25% cap?', answer: 'Yes for many states. Texas, Pennsylvania, North Carolina, and South Carolina generally bar wage garnishment for ordinary consumer debt outright, and several other states set a lower percentage cap than the federal 25% maximum — always confirm your state\'s specific rule, since the federal number is only the outer limit, not a guarantee it applies.' },
]
...
export default function Page() {
  return <>
    ...
    <CalculatorClient faqs={faqs} structuredData={structuredData} relatedCalculators={relatedCalculators} />
        <CalculatorBatch20DeepDive slug="wage-garnishment-calculator" />
</>
}
