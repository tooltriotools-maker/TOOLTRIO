...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="SIP vs PPF Calculator India 2026" description="Compare SIP equity mutual fund returns vs PPF guaranteed 7.1% tax-free returns." icon="🏛️" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="sip-vs-ppf-calculator">
