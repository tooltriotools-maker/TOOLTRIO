...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="SIP vs Bonds Calculator India 2026" description="Compare SIP equity mutual fund vs government and corporate bonds on long-term wealth." icon="📜" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="sip-vs-bonds-calculator">
