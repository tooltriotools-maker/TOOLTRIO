...
const faqs: {question:string;answer:string}[] = [
  { question: 'What is the Medicare Part D $2,000 out-of-pocket cap?', answer: 'Starting in 2025 under the Inflation Reduction Act, Medicare Part D enrollees have an annual out-of-pocket threshold for covered Part D drugs, indexed after the $2,000 threshold introduced in 2025. Once you hit the threshold, Medicare and the plan sponsor cover 100% of covered drug costs for the rest of the calendar year.' },
