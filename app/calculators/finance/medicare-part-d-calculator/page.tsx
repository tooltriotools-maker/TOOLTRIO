...
const faqs: {question:string;answer:string}[] = [
  { question: 'What is the Medicare Part D $2,100 out-of-pocket cap?', answer: 'For 2026, Medicare Part D has a $2,100 annual out-of-pocket threshold for covered Part D drugs. The threshold is indexed annually under the Inflation Reduction Act. Once you hit the threshold, Medicare and the plan sponsor cover 100% of covered drug costs for the rest of the calendar year.' },
...
export default function Page() {
  return <>
    ...
    <CalculatorBatch7DeepDive slug="medicare-part-d-calculator" />
  </>
}
