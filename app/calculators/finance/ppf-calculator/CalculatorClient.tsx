...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="PPF Calculator India 2026" description="Calculate PPF maturity value, year-by-year growth, and tax-free returns at 7.1% current rate." icon="🏛️" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="ppf-calculator">
