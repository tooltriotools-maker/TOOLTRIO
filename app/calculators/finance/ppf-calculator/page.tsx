...
const faqs = [
  { question: 'What is the current PPF interest rate?', answer: 'The Public Provident Fund rate is declared quarterly by the Government of India\'s Ministry of Finance. The applicable PPF rate is declared by the Government of India for each small-savings period. Do not hard-code one rate as permanent; verify the current official rate when using the calculator. The rate is not fixed in perpetuity — it fluctuates with the government\'s fiscal policy and market interest rates. Historical range: PPF has paid between 7.1% and 12% over the past three decades, with higher rates in the 1990s and gradual decline since. The key distinction: the rate is fixed for each quarter you\'re in, not for the life of the account. Compare this to bank FDs, where the rate is locked for the deposit tenure.' },
