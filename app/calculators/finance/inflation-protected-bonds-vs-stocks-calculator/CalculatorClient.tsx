...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="TIPS vs Stocks Calculator USA 2026" description="Compare TIPS inflation-protected bonds vs S&P 500 equities on real return and volatility." icon="📈" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="inflation-protected-bonds-vs-stocks-calculator">
