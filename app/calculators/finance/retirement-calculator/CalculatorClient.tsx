...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Retirement Calculator USA 2026" description={`Plan your retirement corpus in ${currency.name}. Calculate exactly how much you need and how much to save monthly.`} icon="🌅" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="retirement-calculator">
