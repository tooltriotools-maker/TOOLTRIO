...
export default function Page() {
 ...
 return (
    <>
      ...
      <CalculatorClient faqs={faqs} blogSlug="bonds-vs-cds-safe-investment-guide-usa-2026" structuredData={[generateFAQStructuredData(faqs)]} relatedCalculators={relatedCalculators} />
    </>
  )
}
