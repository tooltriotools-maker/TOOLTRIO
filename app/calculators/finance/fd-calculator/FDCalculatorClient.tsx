...
export default function FDCalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="CD Fixed Deposit Calculator USA 2026" description="Calculate interest earned, maturity value, and effective annual yield for any certificate of deposit." icon="🏛️" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="fd-calculator">
