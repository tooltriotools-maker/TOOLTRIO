...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes — the IRS requires reporting of all crypto transactions on Form 1040 Schedule D and Form 8949. You must also answer 'Yes' to the crypto question on Form 1040. Failure to report can result in tax, interest, penalties and potentially more serious consequences depending on the facts. U.S. brokers generally use Form 1099-DA to report digital-asset dispositions; the reporting rules apply to sales effected after 2024/for 2025 reporting, with expanded basis reporting for covered digital assets acquired after 2025. Keep records of every transaction, including blockchain transactions without a 1099.",
  },
