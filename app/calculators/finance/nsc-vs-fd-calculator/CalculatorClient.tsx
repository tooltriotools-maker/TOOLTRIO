...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="NSC vs FD Calculator India 2026" description="Compare National Savings Certificate vs Fixed Deposit on post-tax returns and tax benefits." icon="📮" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="nsc-vs-fd-calculator">
