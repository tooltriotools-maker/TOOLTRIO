...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators }: Props) {
  ...
  return (
    <CalculatorLayout title="Margin Trading Calculator USA 2026" description="Calculate margin trading returns, interest costs, leverage amplification, and break-even return rate." icon="📉" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="margin-trading-calculator">
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to use and interpret this margin trading calculator</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
            <p>This calculator uses Total Invested, Gross Return, Interest Cost, Net Return, Leveraged Return %, Unleveraged Return % to produce the results displayed above. Change one input at a time when comparing scenarios so you can see which assumption is responsible for the difference.</p>
