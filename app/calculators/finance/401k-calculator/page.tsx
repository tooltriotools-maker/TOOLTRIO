...
},
{
 ...
 { question: 'What is the 401k contribution limit for 2026?', answer: 'For 2026, the basic 401(k) elective-deferral limit is $24,500. The standard age-50 catch-up is $8,000, with a higher $11,250 catch-up for participants ages 60–63 who are eligible. The overall annual-additions limit is generally $72,000 before catch-up contributions. Always confirm your plan terms and current IRS limits.' },
 ...
 { question: 'How much should I contribute to my 401k?', answer: 'At minimum, contribute enough to capture your full employer match -- this is a 100% instant return. Most employers match 3-6% of salary. Beyond that, financial planners typically recommend 10-15% of gross income total (employee + employer). If budget allows, work toward the applicable 2026 limit; the basic elective-deferral limit is $24,500, with age-based catch-up rules that can raise the maximum.' },
 ...
 { question: 'How much will my 401k be worth when I retire?', answer: 'It depends on your starting balance, contributions, employer match, rate of return, and years until retirement. Rule of thumb: $500/month at 7% for 30 years = $607,000. Our 401k calculator shows your personalized projection using your contribution and employer-match assumptions; the page separately shows the applicable 2026 IRS limits. Starting at 25 vs 35 at $500/month = $1,322,164 vs $606,438 -- a $715,726 difference from 10 extra years.' },
 { question: 'Can I have both a 401k and a Roth IRA?', answer: 'Yes -- and this is the optimal strategy for most Americans. You can contribute to both in the same year as long as your income is under the Roth IRA phaseout range ($153,000–$168,000 single/head of household; $242,000–$252,000 married filing jointly in 2026). Recommended order: (1) 401k up to full employer match, (2) max Roth IRA ($7,500 under age 50), (3) return to max 401k ($24,500 basic limit). This maximizes both employer free money and tax-free growth.' },
