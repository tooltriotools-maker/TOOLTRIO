...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="SIP vs Gold Calculator India 2026" description="Compare monthly SIP mutual fund returns vs gold investment on long-term wealth building." icon="🥇" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="sip-vs-gold-calculator">
