...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Roth IRA vs HSA Calculator USA 2026" description="Compare Roth IRA vs Health Savings Account on tax advantages, limits, and retirement flexibility." icon="📊" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="roth-ira-vs-hsa-calculator">
