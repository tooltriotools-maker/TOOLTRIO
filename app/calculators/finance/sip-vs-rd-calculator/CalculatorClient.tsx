...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="SIP vs RD Calculator India 2026" description="Compare monthly SIP mutual fund vs bank Recurring Deposit returns over 3–20 years." icon="📊" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="sip-vs-rd-calculator">
