    ...
    <CalculatorLayout title="Mortgage Refinance Calculator USA 2026" description="Calculate monthly savings, break-even month, and total interest saved from refinancing." icon="🔄" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="mortgage-refinance-calculator">
          ...
          <div className={`rounded-2xl border p-5 ${result.worthRefinancing ? 'bg-green-50 border-green-200' : 'bg-orange-50 border-orange-200'}`}>
            <div className="flex items-center justify-between flex-wrap gap-3">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-black text-gray-900" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>{result.breakEvenMonths ? `${result.breakEvenMonths} months` : 'N/A'}</p>
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Use this Mortgage Refinance USA 2026 tool to compare different loan amounts, interest rates, and terms to find your one option.
        </p>
      </Card>
      <SEOContent
