...
export const metadata: Metadata = generateCalculatorMetadata({
 ...
 description: 'Free income tax calculator USA 2026. Calculate your federal income tax, effective tax rate, and marginal bracket. Includes standard deductions and 2026.',
