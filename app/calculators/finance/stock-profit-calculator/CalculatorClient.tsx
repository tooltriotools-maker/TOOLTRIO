...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Stock Profit Calculator USA 2026" description={`Calculate stock trade profit, ROI and after-tax returns in ${currency.name}.`} icon="📈" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="stock-profit-calculator">
