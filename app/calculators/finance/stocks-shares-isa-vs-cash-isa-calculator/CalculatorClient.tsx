...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Stocks ISA vs Cash ISA Calculator UK 2026" description="Compare Stocks and Shares ISA vs Cash ISA on historical returns and long-term wealth." icon="📈" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug}>
