...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Real Return Calculator USA 2026" description="Calculate your inflation-adjusted real return vs nominal return for any investment." icon="📉" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="real-return-calculator">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-red-50 border border-gray-200 rounded-2xl p-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-2xl font-black text-gray-900" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>{fmt(result.nominalFV)}</p>
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Adjust inputs to see Real Return Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
      <SEOContent
