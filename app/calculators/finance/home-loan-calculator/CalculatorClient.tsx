...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Home Loan Calculator USA 2026" description={`Calculate your home loan EMI, amortization, and total interest in ${currency.name}.`} icon="🏠" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="home-loan-calculator">
...
Income tax benefits change the true net cost of a home loan: Section 24 allows deduction of up to ₹2 lakh per year in home loan interest (for self-occupied property), and Section 80C allows deduction of principal repayment up to ₹1.5 lakh. At 30% tax bracket, these combined deductions can save ₹1.05 lakh annually — effectively reducing your net interest rate.`}
        howItWorks={`Monthly payment calculation: Standard amortization formula. Payment = P × r(1+r)^n / [(1+r)^n - 1], where r = monthly rate = annual rate/12. For an example loan, the calculator uses the entered principal, rate and term; the result is a scenario, not a lender quote.
...
Tax benefit calculation: Annual interest paid (from amortization schedule, front-loaded in early years) × tax bracket rate, up to Section 24 limit of ₹2,00,000. Plus principal repayment × tax bracket, up to ₹1,50,000 Section 80C limit. Net loan cost = Total interest - Tax savings over loan tenure.`}
        ...
        tipsSection={`Prepayment is the most useful tool for reducing total home loan cost. On a ₹50 lakh loan at 9.5% for 20 years, prepaying ₹5 lakh in year 3 saves approximately ₹18-20 lakh in interest and reduces tenure by 3-4 years. Most Indian banks allow partial prepayments on floating rate loans without penalty.
