...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Home Loan Calculator USA 2026" description={`Calculate your home loan EMI, amortization, and total interest in ${currency.name}.`} icon="🏠" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="home-loan-calculator">
