    ...
    <CalculatorLayout title="Social Security Couples Optimization Calculator USA 2026" description="Find the Social Security claiming strategy that maximizes lifetime benefits for married couples across 6 different age-combination strategies." icon="👫" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="social-security-couples-optimizer">
      ...
      <div className="mt-8">
        <Card className="space-y-5">
          <section><h2 className="text-xl font-black text-gray-900 mb-2">How Social Security Couples Optimization Calculator Works</h2><p className="text-sm leading-6 text-gray-700">The current model assumes FRA 67, 70% of PIA at age 62 and 124% at age 70, then multiplies each strategy’s combined annual benefit by a simplified remaining-life period. These factors broadly match workers born in 1960 or later, but the lifetime model is intentionally simplified.</p></section>
