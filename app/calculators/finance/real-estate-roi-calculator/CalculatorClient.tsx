...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Real Estate ROI Calculator USA 2026" description="Calculate cap rate, cash-on-cash return, net operating income, and total ROI for any rental property." icon="🏘️" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="real-estate-roi-calculator">
