...
const InterestRateCalculatorClient = dynamic(() => import('./InterestRateCalculatorClient'), {
...
const faqs = [
 ...
 { question: 'What is a good interest rate on a loan?', answer: 'Good rates vary by loan type in 2026: Mortgage (30-yr, 720+ credit): 6.5-7.5%. Auto loan (new, 720+): 5-7%. Personal loan (720+): 7-12%. Student loan (federal): 5.5-8.05%. Credit card (average): 20-25%. If your current rate is significantly higher than these benchmarks, refinancing or paying off the debt early could can reduce interest in some scenarios.' },
