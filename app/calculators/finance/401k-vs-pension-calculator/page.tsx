...
export default function Page() {
 ...
 return (
    <>
      ...
      <CalculatorClient faqs={faqs} blogSlug="401k-vs-pension-guide-usa-2026" structuredData={[generateFAQStructuredData(faqs)]} relatedCalculators={relatedCalculators} />
    </>
  )
}
