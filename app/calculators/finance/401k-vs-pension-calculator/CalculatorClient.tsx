...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="401k vs Pension Calculator USA 2026" description="Compare self-directed 401k growth vs defined benefit pension income at retirement." icon="🏦" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="401k-vs-pension-calculator">
