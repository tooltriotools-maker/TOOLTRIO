          ...
          <Card>
            ...
            <div className="space-y-2 text-sm">
              ...
              {optionType === 'nso' ? <>
                ...
                <div className="flex justify-between text-orange-500"><span>FICA Tax (7.65%)</span><span className="font-semibold">-{fmt('ficaTax' in result ? result.ficaTax : 0)}</span></div>
              </> : <>
