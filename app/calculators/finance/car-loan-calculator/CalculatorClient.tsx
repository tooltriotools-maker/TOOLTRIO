...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Car Loan Calculator USA 2026" description="Calculate your exact monthly car payment, total interest, and full amortization schedule." icon="🚗" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="car-loan-calculator">
