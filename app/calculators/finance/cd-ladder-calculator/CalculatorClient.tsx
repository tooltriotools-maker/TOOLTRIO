...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="CD Ladder Calculator USA 2026" description="Build a certificate of deposit laddering strategy to maximize FDIC-insured yield with annual liquidity." icon="🏗️" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="cd-ladder-calculator">
