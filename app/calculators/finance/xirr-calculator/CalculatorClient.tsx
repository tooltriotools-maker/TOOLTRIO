...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="XIRR Calculator USA 2026" description="Calculate the true annualized return for investment portfolios with multiple irregular cash flows." icon="📐" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="xirr-calculator">
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Adjust inputs to see Xirr Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
      <SEOContent
