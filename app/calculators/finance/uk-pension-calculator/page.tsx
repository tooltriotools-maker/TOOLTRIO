...
export default function Page() { return <>
      ...
      <CalculatorClient faqs={faqs} structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug="uk-pension-guide-auto-enrolment-state-pension-drawdown-2026" />
    </> }
