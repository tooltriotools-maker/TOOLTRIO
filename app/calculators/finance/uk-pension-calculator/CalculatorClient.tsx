    ...
    <CalculatorLayout title="UK Pension Calculator 2026" description="Calculate workplace pension pot, auto-enrolment contributions, and projected monthly retirement income." icon="🏦" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="uk-pension-calculator">
          ...
          <button onClick={() => setIncludeStatePension(!includeStatePension)}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400">£12,547.60/yr (2026/27 full new State Pension rate)</p>
              </div>
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          This UK Pension 2026 tool helps you model claiming strategies and determine the optimal age to start benefits based on your situation.
        </p>
      </Card>
