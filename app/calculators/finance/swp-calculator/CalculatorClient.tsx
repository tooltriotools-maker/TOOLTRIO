...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="SWP Calculator India 2026" description="Calculate monthly income from mutual fund corpus using Systematic Withdrawal Plan." icon="💸" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="swp-calculator">
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Adjust inputs to see Swp Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
