...
export default function Page() { return <>
      ...
      <CalculatorClient faqs={faqs} structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug="car-finance-guide-pcp-hp-personal-loan-uk-europe-2026" />
    </> }
