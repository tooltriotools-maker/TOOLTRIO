...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Car Depreciation Calculator USA 2026" description="Calculate how much your vehicle loses in value per year and the true total cost of ownership." icon="🚗" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="car-depreciation-calculator">
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Adjust inputs to see Car Depreciation Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
      <SEOContent
