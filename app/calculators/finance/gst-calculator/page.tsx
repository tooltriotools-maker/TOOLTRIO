...
export const metadata: Metadata = generateCalculatorMetadata({
 ...
 description: 'Free sales tax and GST calculator USA 2026. Calculate tax-inclusive and tax-exclusive amounts, reverse-calculate pre-tax price, and compare rates across.',
 slug: 'gst-calculator',
 category: 'finance',
 keywords: [
    'gst calculator 2026',
