...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Mutual Fund Calculator USA 2026" description="See how expense ratios and fees erode long-term returns compared to low-cost index funds." icon="📊" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="mutual-fund-calculator">
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Adjust inputs to see Mutual Fund Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
      <SEOContent
