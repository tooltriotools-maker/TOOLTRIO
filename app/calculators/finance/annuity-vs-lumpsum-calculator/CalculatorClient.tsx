...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Annuity vs Lump Sum Calculator USA 2026" description="Compare guaranteed annuity income vs investing a lump sum payout with break-even age analysis." icon="📊" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="annuity-vs-lumpsum-calculator">
