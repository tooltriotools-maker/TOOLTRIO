...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Medicare vs Private Insurance Calculator USA 2026" description="Compare Medicare Parts A, B, C, D vs private insurance for retirement healthcare costs." icon="🏥" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="medicare-vs-private-insurance-calculator">
