...
export const metadata: Metadata = generateCalculatorMetadata({
 ...
 description: 'Free salary calculator USA 2026. Calculate take-home pay after federal tax, state tax, Social Security, Medicare, and pre-tax deductions. Compare salary.',
