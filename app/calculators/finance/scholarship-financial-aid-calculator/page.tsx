...
const faqs = [
  ...
  { question: 'Is the entered EFC the current FAFSA Student Aid Index?', answer: 'No. The calculator retains an EFC-style planning input and uses its own simplified formula. Current federal aid determinations come from FAFSA data and federal Student Aid Index rules.' },
  { question: 'What is the 2026–27 maximum Pell Grant?', answer: 'Federal Student Aid lists $7,395 as the maximum Pell Grant for the 2026–27 award year. Actual awards depend on federal eligibility and enrollment factors.' },
]
...
export default function Page() {
  return <>
    ...
    <CalculatorClient faqs={faqs} relatedCalculators={relatedCalculators} />
        <CalculatorBatch33DeepDive slug="scholarship-financial-aid-calculator" />
</>
}
