...
export default function Page() {
 return <>
      ...
      <CalculatorClient faqs={faqs} relatedCalculators={relatedCalculators} blogSlug="net-worth-guide-how-to-calculate-and-grow-your-wealth" />
    </>
}
