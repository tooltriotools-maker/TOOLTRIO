...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Roth IRA Calculator USA 2026" description="See how much your Roth IRA will be worth at retirement with tax-free compound growth." icon="🛡️" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="roth-ira-calculator">
