...
const faqs = [
  { question: 'What are the Roth IRA income and contribution limits for 2026?', answer: 'Contribution limits for 2026: $7,500 for individuals under 50; $8,600 for those 50 and older (including the $1,100 IRA catch-up). Income phase-out for direct contributions: single filers phase out between $153,000-$168,000 MAGI; married filing jointly phase out between $242,000-$252,000. Above these limits, direct contributions are prohibited but the backdoor Roth (non-deductible traditional IRA contribution followed by conversion) remains available regardless of income. There is no income limit for Roth conversions from traditional IRA.' },
...
export default function Page() {
 return <>
      ...
      <CalculatorClient faqs={faqs} relatedCalculators={relatedCalculators} blogSlug="retirement-planning-guide-how-much-do-you-need-to-retire" />
          <CalculatorBatch57DeepDive slug="roth-ira-calculator" />
</>
}
