    ...
    <CalculatorLayout title="Recurring Deposit Calculator India 2026" description="Calculate RD maturity value, total interest earned, and month-by-month growth." icon="🏧" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="rd-calculator">
      ...
      <Card className="mt-6">
        <h2 className="text-lg font-black text-gray-900 mb-3">
          RD Calculator Example (India 2026)
        </h2>
        <p className="text-sm text-gray-600 mb-2">
          Use this RD India 2026 calculator to model your specific numbers and make confident financial decisions based on accurate projections.
        </p>
        <p className="text-sm text-gray-600">
          Adjust inputs to see Rd Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
