...
export const metadata: Metadata = generateCalculatorMetadata({
 ...
 description: 'Free salary hike calculator USA 2026. Calculate the exact take-home impact of any salary raise, lifetime earnings increase, and investment value of a.',
...
export default function Page() {
 return <>
      ...
      <CalculatorClient faqs={faqs} structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug='savings-goal-guide-emergency-fund-down-payment-usa' />
    </>
}
