...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Net Worth Calculator USA 2026" description={`Track your total net worth in ${currency.name}. Add assets and liabilities for a complete financial picture.`} icon="⚖️" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="net-worth-calculator">
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Adjust inputs to see Net Worth Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
