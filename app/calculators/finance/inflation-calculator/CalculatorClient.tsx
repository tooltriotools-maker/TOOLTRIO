...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Inflation Calculator USA 2026" description={`See how inflation erodes purchasing power in ${currency.name}. Plan your savings to beat inflation.`} icon="📊" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="inflation-calculator">
