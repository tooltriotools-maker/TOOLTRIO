...
export const metadata: Metadata = generateCalculatorMetadata({ title: 'COBRA vs ACA Marketplace Calculator USA 2026 | ToolTrio', description: 'Compare COBRA health insurance cost vs ACA Marketplace plan with subsidy eligibility. Calculate net monthly premiums and annual savings for USA 2026.', slug: 'cobra-vs-marketplace-calculator', category: 'finance', region: 'usa', keywords: ['COBRA vs marketplace calculator', 'ACA subsidy calculator 2026', 'health insurance comparison COBRA', 'marketplace premium calculator USA'] })
const faqs = [
