...
const faqs = [
  { question: 'What is a good interest rate on a personal loan in 2026?', answer: 'There is no single good personal-loan APR for every borrower. Rates vary by credit profile, lender, loan amount, term, fees and market conditions. Compare APR and total repayment using actual lender disclosures rather than relying on a generic rate band.' },
