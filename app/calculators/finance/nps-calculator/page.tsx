...
const faqs = [
  ...
  { question: 'How does NPS compare to EPF for retirement savings?', answer: 'EPF: government-guaranteed 8.15% rate (2024-2025), fully tax-free (EEE), mandatory for salaried employees in formal sector, employer contributes an equal 12% of basic salary. NPS: market-linked returns (historically 10-12% for equity allocation), partially taxable at maturity (annuity portion), voluntary beyond mandatory corporate contribution, additional Rs 50,000 deduction under 80CCD(1B). EPF is the more reliable base with stated return under the applicable termss and full tax exemption. NPS adds the possibility of higher equity-linked returns and the unique additional tax deduction. The optimal strategy: maximize EPF (mandatory and inherently optimized), then contribute Rs 50,000/year to NPS Tier I specifically to capture the 80CCD(1B) benefit.' },
