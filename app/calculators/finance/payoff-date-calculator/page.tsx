...
const PayoffDateCalculatorClient = dynamic(() => import('./PayoffDateCalculatorClient'), {
...
export default function PayoffDatePage() {
 ...
 blogSlug="debt-payoff-guide-usa-2026" />
          <CalculatorBatch47DeepDive slug="payoff-date-calculator" />
</>
}
