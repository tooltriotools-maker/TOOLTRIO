...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="France PEA vs Assurance-Vie Calculator 2026" description="Compare Plan Epargne en Actions vs Assurance-Vie on tax efficiency and long-term wealth building." icon="🇫🇷" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="france-pea-vs-assurance-vie-calculator">
