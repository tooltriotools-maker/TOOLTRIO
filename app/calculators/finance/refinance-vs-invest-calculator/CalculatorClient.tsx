...
But risk matters. A 6.5% mortgage prepayment delivers a guaranteed 6.5% return. The stock market's expected return is higher but uncertain — in any given 5-year period, equity returns range from deeply negative to spectacularly positive. The appropriate comparison is not 6.5% vs 8% expected equity return but 6.5% contractual interest saving versus an uncertain 8% expected investment return.`}
