...
const ClosingCostCalculatorClient = dynamic(() => import('./ClosingCostCalculatorClient'), {
...
const faqs = [
 { question: 'How much are closing costs on a home in 2026?', answer: 'Closing costs typically range from 2% to 5% of the home purchase price. On a $400,000 home: 2-5% = $8,000-$20,000. Closing costs often fall within a broad percentage range, but the actual amount varies by lender, location, loan type, and transaction. Costs vary significantly by state -- New York and Pennsylvania have some of the highest, while Missouri and Indiana have the lowest. Get a Loan Estimate from your lender within 3 days of applying for exact figures.' },
