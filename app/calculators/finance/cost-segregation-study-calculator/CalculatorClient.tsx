...
export default function CalculatorClient({faqs,structuredData,relatedCalculators}:Props){
  ...
  return(
    <CalculatorLayout title="Cost Segregation Study Calculator USA 2026" description="Calculate the first-year tax savings from a cost segregation study — accelerating depreciation on 5/7/15-year components of commercial or residential property." icon="🏗️" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} slug="cost-segregation-study-calculator">
      ...
      <div className="mt-8">
        <SEOContent title="Cost Segregation Study Calculator USA 2026" category="finance" intro="Calculate the first-year tax savings from a cost segregation study — accelerating depreciation on 5/7/15-year components of commercial or residential property." howItWorks="Enter values for instant 2026 results." tipsSection="Try different scenarios." conclusion="Consult a qualified financial advisor."
