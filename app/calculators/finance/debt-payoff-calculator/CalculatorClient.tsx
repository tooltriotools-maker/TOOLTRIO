...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Debt Payoff Calculator USA 2026" description={`Find the fastest way to pay off all your debts using avalanche or snowball method in ${currency.name}.`} icon="🔓" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="debt-payoff-calculator">
