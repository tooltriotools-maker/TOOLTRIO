...
Net worth impact: Each dollar of debt eliminated increases your net worth by exactly one dollar. Unlike equity investments (which carry risk), debt payoff is a guaranteed net worth improvement. The psychological value of a specific debt-free date — made visible by the calculator — is a useful motivational tool.`}
        benefits={[
...
For student loans specifically, the calculus is sometimes different — low-rate student debt (under 5-6%) may not be worth accelerating if you're also saving for retirement in tax-advantaged accounts. The [Pay Off Mortgage vs Invest Calculator](/calculators/finance/pay-off-mortgage-vs-invest-calculator) logic applies to student loans: compare the stated return under the applicable terms of paying off the debt to the expected return of investing the same money.`}
      />
      <InternalLinks
