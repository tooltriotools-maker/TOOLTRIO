...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="FIRE Calculator USA 2026" description={`Calculate your Financial Independence number and timeline in ${currency.name}.`} icon="🔥" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="fire-calculator">
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600 leading-relaxed">
            <div>
              ...
              <p>The savings rate is the most useful variable. On a $80,000 income: 10% savings rate (~45 years to FI), 25% savings rate (~32 years), 50% savings rate (~17 years), 70% savings rate (~8.5 years). Increasing income while keeping expenses flat is the ultimate FIRE accelerator -- each additional dollar saved compounds at your portfolio return rate, not just sits in a savings account.</p>
            </div>
            <div>
