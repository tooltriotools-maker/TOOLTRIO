...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="FIRE Calculator USA 2026" description={`Calculate your Financial Independence number and timeline in ${currency.name}.`} icon="🔥" category="Finance" structuredData={} relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="fire-calculator">
