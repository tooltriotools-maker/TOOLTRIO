...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Loan Prepayment Calculator USA 2026" description="Calculate interest saved and months eliminated with any extra monthly or lump sum payment." icon="💰" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="loan-prepayment-calculator">
...
ROI comparison: Prepayment benefit = interest avoided under the loan terms. Investment return = expected market return × (1 - tax rate on returns). At 6.5% mortgage and 7% expected stock return with 20% investment tax: after-tax investment = 5.6% — below the guaranteed 6.5% prepayment return. At higher stock return expectations or tax-advantaged investment accounts, the comparison shifts.`}
        benefits={[
        ...
        tipsSection={`Prioritize tax-advantaged investment accounts over mortgage prepayment for most people. A 401k contribution saves 22-32% in taxes immediately — that's an immediate employer-match and tax benefit before considering subsequent investment performance. Prepaying a 6.5% mortgage doesn't compete with that.
