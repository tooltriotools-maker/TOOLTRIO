...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Paycheck Calculator USA 2026" description="Calculate your exact take-home pay after federal tax, state tax, Social Security, and Medicare." icon="💵" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="paycheck-calculator">
