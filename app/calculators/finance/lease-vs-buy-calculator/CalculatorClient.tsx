...
export default function CalculatorClient({ faqs, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Lease vs Buy Car Calculator USA 2026" description="Compare total 5-year cost of leasing vs financing a vehicle including residual value and fees." icon="🚘" category="Finance" relatedCalculators={relatedCalculators} blogSlug={blogSlug} slug="lease-vs-buy-calculator">
      ...
      <Card className="mt-6">
        ...
        <p className="text-sm text-gray-600">
          Adjust inputs to see Lease Vs Buy Calculator output — compare scenarios to find the strategy that best fits your financial goals and timeline.
        </p>
      </Card>
