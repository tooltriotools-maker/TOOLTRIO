...
export const metadata: Metadata = generateCalculatorMetadata({
 ...
 description: 'Free government bond calculator USA 2026. Calculate yield to maturity, current yield, bond price, and duration for US Treasuries and European government.',
...
export default function Page() { return <>
      ...
      <CalculatorClient faqs={faqs} structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug="government-bonds-guide-uk-gilts-bunds-oats-yield-2026" />
    </> }
