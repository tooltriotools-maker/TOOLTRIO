        ...
        <Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600 leading-relaxed">
            ...
            <div>
              ...
              <p>German Bunds are a major eurozone sovereign benchmark and are often treated as a relatively lower-risk reference and serve as the benchmark against which all other eurozone bonds are priced. The spread between Italian BTPs and German Bunds (typically 1.5-2.5% in 2026) is a key indicator of eurozone financial stress. When spreads widen, it signals investor concern about peripheral country debt. ECB bond purchase programmes (QE) historically compressed spreads - their removal has allowed spreads to normalise. Germany\'s conservative fiscal policy (debt brake) and manufacturing export strength underpin Bund creditworthiness.</p>
              <h3 className="font-bold text-gray-800 mb-2 mt-4">Gilt Laddering Strategy for UK Retirees</h3>
              <p>A gilt ladder is a portfolio of UK Gilts with staggered maturities (e.g., 1-year, 3-year, 5-year, 7-year, 10-year) providing a predictable income stream. Each year, the maturing gilt provides cash while longer gilts continue earning higher yields. This strategy is used by UK defined benefit pension trustees and cautious retirees who want predictable cash flows without an annuity contract. With 10-year gilt yields around 4.5% in 2026, a £500,000 ladder generates approximately £22,500 per year in tax-free coupon income (held in ISA).</p>
            </div>
          </div>
        </Card>
