...
const EMOJI_MAP: Record<string, string> = {
  ...
  walk: '🚶', dance: '💃', hug: '🤗', kiss: '💋', fist: '✊', clap: '👏', point: '👉',
  sleep: '😴', shrug: '🤷', facepalm: '🤦', celebrate: '🎉', bow: '🙇', swear: '🤬',
  // Nature
  ...
  lightning: '⚡', wind: '🌬️', tornado: '🌪️', wave: '🌊', island: '🏝️',
  // Animals
  dog: '🐕', cat: '🐈', bird: '🐦', lion: '🦁', tiger: '🐯', bear: '🐻', rabbit: '🐰',
  horse: '🐴', cow: '🐄', pig: '🐷', duck: '🦆', eagle: '🦅', owl: '🦉', snake: '🐍',
  ...
  // Weather & sky
  night: '🌃', sunrise: '🌄', sunset: '🌇', storm: '⛈️', fog: '🌫️',
  // Actions & concepts
  ...
  go: '▶️', wait: '⏳', hurry: '⚡', slow: '🐢', fast: '🏃', big: '🔺', small: '🔹',
  good: '👍', bad: '👎', yes: '✅', no: '❌', maybe: '🤷', question: '❓', answer: '💡', idea: '💡',
  problem: '⚠️', solution: '✅', simple: '👌', complex: '🌀', clear: '👁️', dark: '🌑',
  bright: '☀️', hot: '🌡️', cold: '🥶', warm: '☀️', sweet: '🍬', sour: '🍋', spicy: '🌶️',
  ...
  // Sentiments
  okay: '👌', great: '🎉', amazing: '🤩', boring: '😑', interesting: '🤔', cute: '🥰',
