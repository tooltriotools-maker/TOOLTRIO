...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = (k: string, v: string) => {
    ...
    <DevToolLayout
      ...
      icon="🌐"
      description="Calculate network address, subnet mask, host range and more from CIDR notation"
      category="Dev"
    ...
    >
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the cidr calculator output</h2>
