...
Large tables are hard to maintain. Markdown tables over 5 columns become unreadable in source. Consider an HTML table inside a Markdown file for complex data.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the markdown table gen result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Reviewing this markdown table gen</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
