...
EC keys are much smaller. A 256-bit ECDSA key (P-256) provides equivalent security to a 3072-bit RSA key. For new applications, prefer ECDSA or Ed25519 over RSA.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the rsa key info output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the rsa key info result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
