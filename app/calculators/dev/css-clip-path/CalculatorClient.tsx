...
Animate clip-path for reveals. clip-path: inset(0 100% 0 0) to inset(0 0 0 0) creates a left-to-right reveal — a common scroll animation pattern.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the css clip path output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the css clip path result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
