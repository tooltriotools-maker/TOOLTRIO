...
iat (issued at) vs nbf (not before). iat is when the token was issued. nbf is when it becomes valid (useful for tokens issued in advance). Both are Unix timestamps — decoded to readable dates here.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the jwt decoder output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the jwt decoder result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
