import { CalculatorBatch31DeepDive } from '@/components/ui/CalculatorBatch31DeepDive'
...
export default function Page() {
  const jsonLd = generateDevToolJsonLd({
    name: 'Character Encoder — Unicode Code Points & Escape Sequences',
    description: 'Encode and decode characters as Unicode escape sequences, HTML entities, and URL encoding. Runs in your browser.',
    slug: 'character-encoder',
    faqs,
  })
  return (
    <>
      ...
      <CalculatorClient faqs={faqs} />
          <CalculatorBatch31DeepDive slug="character-encoder" />
</>
  )
}
