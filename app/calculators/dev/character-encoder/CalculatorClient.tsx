...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = () => { navigator.clipboard.writeText(output); setCopied(true); setTimeout(()=>setCopied(false),1500) }
      ...
      return (
    <DevToolLayout
      title="Unicode Character Encoder"
      icon="🔡"
...
Surrogate pairs in UTF-16. Characters above U+FFFF are encoded as surrogate pairs in UTF-16 (two 16-bit code units). The [String Inspector](/calculators/dev/string-inspector) shows whether your string contains surrogates.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the character encoder result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the character encoder output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
