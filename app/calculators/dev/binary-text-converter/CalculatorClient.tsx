...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = () => { navigator.clipboard.writeText(output); setCopied(true); setTimeout(()=>setCopied(false),1500) }
      ...
      return (
    <DevToolLayout
      title="01 Binary ↔ Text Converter"
      icon=""
...
Use Base64 for non-text data. Binary files (images, PDFs) should be encoded with [Base64 Encoder](/calculators/dev/base64-encoder), not binary text encoding. This tool is for ASCII text to binary representation, not arbitrary data.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the binary text converter result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the binary text converter output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
