...
Compare API responses for regressions. Run the same API call before and after a change, paste both responses here, and see exactly what changed.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the text diff inline result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the text diff inline output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
