...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const formatted = useMemo(() => {
    ...
    <DevToolLayout
      title="SQL Formatter"
      icon="🗄️"
      description="Format and beautify SQL queries - capitalises keywords and adds clean indentation"
      category="Dev"
...
Diff before and after changes. After modifying a complex query, use [Diff Checker](/calculators/dev/diff-checker) to see exactly what changed — formatted queries produce much more readable diffs than minified ones.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the sql formatter output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the sql formatter result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
