...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = () => { navigator.clipboard.writeText(output); setCopied(true); setTimeout(()=>setCopied(false),1500) }
    ...
    <DevToolLayout
      title="Code Minifier"
      icon="⚡"
      description="Minify CSS, HTML, and JSON code to reduce file size. All processing happens in your browser."
      category="Dev"
    ...
    >
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the code minifier output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the code minifier result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
