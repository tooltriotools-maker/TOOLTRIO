...
Fluid spacing too. padding: clamp(1rem, 4vw, 3rem) creates responsive spacing without media queries — same technique as typography.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the font size calculator result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the font size calculator output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
