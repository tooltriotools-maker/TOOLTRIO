...
Inline styles beat everything. style=color:red has specificity (1,0,0,0) — higher than any stylesheet selector. Avoid inline styles in component markup.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the css specificity result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the css specificity output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
