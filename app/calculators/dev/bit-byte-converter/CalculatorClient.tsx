...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const fmt = (n: number) => n < 0.001 ? n.toExponential(3) : n < 1 ? n.toFixed(6) : n >= 1e12 ? (n/1e12).toFixed(4)+'T' : n.toLocaleString(undefined,{maximumFractionDigits:4})
    ...
    >
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the bit byte converter result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the bit byte converter output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
