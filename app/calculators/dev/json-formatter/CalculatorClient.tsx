...
Combine it with [JSONPath Tester](/calculators/dev/json-path-tester) for field extraction and [JSON Schema Generator](/calculators/dev/json-schema-gen) to auto-generate validation schemas.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the json formatter output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the json formatter result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
