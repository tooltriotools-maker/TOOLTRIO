...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = (text: string, key: string) => { navigator.clipboard.writeText(text); setCopied(key); setTimeout(()=>setCopied(null),1500) }
    ...
    <DevToolLayout
      ...
      icon="🔤"
      description="Convert text between all common naming conventions and case styles instantly."
      category="Dev"
...
Screaming snake case for constants. MAX_RETRY_COUNT, DEFAULT_TIMEOUT — SCREAMING_SNAKE_CASE is the convention for constants in Python, Java, and many other languages.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the text case converter output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the text case converter result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
