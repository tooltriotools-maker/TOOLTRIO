...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const toggleField = (f: string) => setFields(prev => prev.includes(f) ? prev.filter(x=>x!==f) : [...prev, f])
    ...
    <DevToolLayout
      ...
      icon="🎭"
      description="Generate realistic test data - names, emails, addresses, UUIDs and more"
      category="Dev"
...
SQL INSERT for development seeding. The SQL output generates standard INSERT statements. Format with [SQL Formatter](/calculators/dev/sql-formatter) before running.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the fake data generator result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the fake data generator output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
