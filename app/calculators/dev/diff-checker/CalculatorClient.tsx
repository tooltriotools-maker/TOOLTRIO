...
Environment comparison. Copy .env.development and .env.production to the two panels to find variables present in one but missing in the other.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the diff checker result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the diff checker output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
