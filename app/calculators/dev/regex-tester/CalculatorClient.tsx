...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const TOGGLE_FLAGS = ['g', 'i', 'm', 's', 'u']
    ...
    <DevToolLayout
      title="Regex Tester"
      icon="🔍"
      description="Live regular expression testing with match highlighting"
      category="Dev"
...
The g flag is usually what you want. Without the global flag, the regex only finds the first match. Add the g flag when you need all matches.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the regex tester output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the regex tester result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
