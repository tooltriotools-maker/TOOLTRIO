...
For infrastructure workflows: generate base configs with [Docker Compose Generator](/calculators/dev/docker-compose-gen), format and validate here, then diff changes with [Diff Checker](/calculators/dev/diff-checker).`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the yaml formatter result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the yaml formatter output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
