...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const shades = [10,20,30,40,50,60,70,80,90].map(lightness => {
    ...
    <DevToolLayout
      ...
      icon="🎨"
      description="Convert between HEX, RGB, HSL, and CSS formats. See contrast ratios, shades, and tints instantly."
      category="Dev"
...
Pair it with our CSS Gradient Generator and Color Contrast tools for a complete front-end color workflow. No installs, no sign-ups, no limits - professional color conversion available to any American developer right in their browser.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the color converter result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the color converter output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
