...
For the full SQL workflow: design JOINs here, format queries with [SQL Formatter](/calculators/dev/sql-formatter), generate test data with [Fake Data Generator](/calculators/dev/fake-data-generator).`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the sql join visualizer output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the sql join visualizer result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
