...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const { formatted, error } = formatGql(input)
    ...
    <DevToolLayout
      ...
      icon=""
      description="Format and beautify GraphQL queries, mutations, and subscriptions with proper indentation. Copy formatted code instantly."
      category="Dev"
...
According to the 2024 State of GraphQL survey, 58% of GraphQL users say the strongly-typed schema is the primary benefit over REST, 47% cite the elimination of over-fetching, and 39% value the self-documenting nature of GraphQL schemas through introspection.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the graphql formatter result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the graphql formatter output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
