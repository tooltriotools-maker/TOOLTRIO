...
const BWPRESETS = [
  ...
  { l: 'USB 3.0 5Gbps', bw: 5, u: 'Gbps' as const }
    ...
    >
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the bandwidth calculator result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the bandwidth calculator output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
