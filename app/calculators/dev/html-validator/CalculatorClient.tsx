...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = () => { navigator.clipboard.writeText(output); setCopied(true); setTimeout(()=>setCopied(false),1500) }
      ...
      return (
    <DevToolLayout
      title="HTML Structure Validator"
      icon="🏗️"
...
Validate template output. Paste rendered HTML from your server-side templates here to catch issues that template syntax hides.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the html validator result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the html validator output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
