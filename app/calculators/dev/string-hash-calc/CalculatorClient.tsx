...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = () => { navigator.clipboard.writeText(output); setCopied(true); setTimeout(()=>setCopied(false),1500) }
      ...
      return (
    <DevToolLayout
      title="#️⃣ String Hash Calculator"
      icon=""
...
For HMAC API signing. API request signing (AWS Signature V4, Stripe webhooks) uses HMAC-SHA256. Use [Hash Generator](/calculators/dev/hash-generator) for HMAC support with a key.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the string hash calc result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the string hash calc output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
