...
export default function CalculatorClient({ faqs }: Props) {
  ...
  useState(() => { generate() })
    ...
    <DevToolLayout
      ...
      icon="🔑"
      description="Generate strong, random passwords. Runs entirely in your browser - never sent anywhere."
      category="Dev"
...
Do not use passwords as secrets in code. Use environment variables and secrets management instead. Passwords generated here are for human authentication, not for hardcoding in source code.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the password generator output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the password generator result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
