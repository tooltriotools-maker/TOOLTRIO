...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const EXAMPLES = ['Hello, World!', 'password123', 'The quick brown fox', '']
    ...
    <DevToolLayout
      ...
      icon=""
      description="Generate SHA-1, SHA-256, SHA-384, SHA-512 hashes using the browser's native Web Crypto API. Nothing leaves your device."
      category="Dev"
...
HMAC for API signing. An HMAC is a hash of the message + a secret key. API request signing (AWS Signature V4, Stripe webhooks) uses HMAC-SHA256. Enter both the message and key here.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the hash generator output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the hash generator result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
