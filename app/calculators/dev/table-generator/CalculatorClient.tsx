...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const output = generate()
    ...
    <DevToolLayout
      ...
      icon="📊"
      description="Build tables visually and export to Markdown, HTML, CSV, or JSON. Add/remove rows and columns with one click."
      category="Dev"
...
Do not use tables for layout. HTML tables are for tabular data only. CSS Grid and Flexbox handle layout. Misusing tables breaks screen readers and responsive design.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the table generator output</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the table generator result</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
