...
3,Carol White,carol@email.net,42,true`)
  ...
  const result = useMemo(() => {
    ...
    <DevToolLayout
      ...
      icon="📊"
      description="Convert CSV data to JSON array - headers auto-detected, custom delimiter support"
      category="Dev"
...
For the full data transformation workflow: convert here, validate with [JSON Formatter](/calculators/dev/json-formatter), extract fields with [JSONPath Tester](/calculators/dev/json-path-tester).`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the csv to json result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the csv to json output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
