...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const analysis = useMemo(() => {
    ...
    <DevToolLayout
      ...
      icon="🔬"
      description="Analyse any string: length, bytes, Unicode codepoints, frequency analysis"
      category="Dev"
...
Control characters in pasted text. Text copied from PDF files sometimes includes control characters (backspace, form feed) that cause unexpected behavior.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the string inspector result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the string inspector output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
