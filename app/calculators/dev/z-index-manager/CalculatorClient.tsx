...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const copy = () => { navigator.clipboard.writeText(output); setCopied(true); setTimeout(()=>setCopied(false),1500) }
      ...
      return (
    <DevToolLayout
      title="Z-Index Stacking Visualiser"
      icon="🎯"
...
Modals need a dedicated stacking context. Place modals as direct children of body to escape any intermediate stacking contexts.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the z index manager result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the z index manager output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
