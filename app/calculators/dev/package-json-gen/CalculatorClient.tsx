...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const delDep = (type: 'deps'|'devDeps', i: number) => setPkg(p=>({...p,[type]:p[type].filter((_,j)=>j!==i)}))
    ...
    <DevToolLayout
      ...
      icon="📦"
      description="Fill the wizard on the left, get your perfect package.json on the right"
      category="Dev"
...
Validate after editing. Paste the generated package.json into [JSON Formatter](/calculators/dev/json-formatter) to confirm valid JSON before using it.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the package json gen result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the package json gen output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
