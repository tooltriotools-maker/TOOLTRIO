...
For HTTP debugging: look up status codes here, analyze response headers with [HTTP Headers Analyzer](/calculators/dev/http-headers-analyzer), and build test requests with [curl Builder](/calculators/dev/curl-builder).`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the http status codes result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Reviewing this http status codes</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
