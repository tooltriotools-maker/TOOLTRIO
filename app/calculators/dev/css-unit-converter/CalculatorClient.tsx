...
export default function CalculatorClient({ faqs }: Props) {
  ...
  const px = toPx()
    ...
    >
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to review the css unit converter result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Understanding the css unit converter output</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
