...
export const metadata: Metadata = {
  title: '90+ Free Developer Tools Online | ToolTrio',
  description: '90 free browser-based developer tools for engineers worldwide. JSON formatter, regex tester, Base64 encoder, UUID generator, JWT decoder, SQL formatter.',
  keywords: [
    'free developer tools online',
    'online dev tools no install',
    'browser based developer tools',
    'web developer utilities free 2026',
    'best free online developer tools',
    'dev tools no signup',
    'developer toolbox online',
    'software engineer tools online',
  ],
...
const softwareAppSchema = {
  ...
  description: '90 free browser-based developer tools including JSON formatter, regex tester, Base64 encoder, UUID generator, JWT decoder, SQL formatter, CSS generators.',
  url: DEV_CATEGORY_URL,
  applicationCategory: 'DeveloperApplication',
  operatingSystem: 'Any',
  offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' },
  author: { '@type': 'Organization', name: 'ToolTrio', url: BASE_URL },
}
                ...
                <Link key={tool.href} href={tool.href}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-gray-900 text-sm group-hover:text-blue-600 transition-all truncate">{tool.name}</h3>
