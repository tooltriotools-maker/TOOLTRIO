...
Entities in XML. Named entities other than &amp; &lt; &gt; &quot; &apos; are not defined in XML 1.0. For XML, use numeric entities or ensure your document declares the HTML entity set.`}
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Using the html entity ref result</h2>
      ...
      <div className="mt-6">
        <Card>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Reviewing this html entity ref</h2>
          <div className="space-y-3 text-sm leading-6 text-gray-600">
