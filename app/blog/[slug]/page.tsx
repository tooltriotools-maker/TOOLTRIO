      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-10 relative">
        ...
        <header className="blog-hero-card mb-8 md:mb-10">
          ...
          <div className="relative p-6 md:p-10 lg:p-12">
            ...
            <h1 className="page-title text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-slate-950 leading-[1.04] max-w-5xl">{post.title} <span className="text-green-600">| ToolTrio</span></h1>
