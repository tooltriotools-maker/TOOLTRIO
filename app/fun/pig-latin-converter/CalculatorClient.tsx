  ...
  <li>- <strong>Clusters</strong> move together (e.g., <em>street → eetstray</em>)</li>
      ...
      <div className="mt-12 space-y-10 max-w-2xl mx-auto">
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">Pig Latin is one of those things most English speakers learn in childhood and then carry for the rest of their lives as a piece of completely useless linguistic knowledge -- until the specific moment it becomes exactly the right register for something. This converter handles the transformation automatically, applying the correct rules for consonant-initial and vowel-initial words without you having to remember them. If Pig Latin is too tame and you want something with more internet energy, the <Link href="/fun/uwu-text-generator" className="text-purple-700 font-semibold underline underline-offset-2 hover:text-purple-900">UWU Text Generator</Link> applies a completely different kind of linguistic chaos.</p>
        </section>
