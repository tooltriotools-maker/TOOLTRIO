  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
        <div>
          <h1 className="text-3xl md:text-4xl font-black text-gray-900" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>🥇 Gold Price Calculator - Live Karat Prices</h1>
      ...
      <div className="mt-12 space-y-10 max-w-4xl mx-auto">
        ...
        {/* Introduction */}
        <section>
          <h2 className="text-2xl font-black text-gray-900 mb-4" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>Gold Price Calculator — Complete Guide 2026</h2>
