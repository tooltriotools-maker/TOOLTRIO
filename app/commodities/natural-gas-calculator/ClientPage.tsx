  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap items-center gap-2 my-4">
        <ShareButton title="Natural Gas Calculator" category="Commodities" />
          <ExportButtonPair title="Natural Gas Calculator" category="Finance" />
      </div>
      <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
        <div>
          <h1 className="text-3xl font-black text-gray-900" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>🔥 Natural Gas Price Calculator</h1>
