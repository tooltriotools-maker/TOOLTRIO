  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap items-center gap-2 my-4">
        <ShareButton title="Palladium Price Calculator" category="Commodities" />
          <ExportButtonPair title="Palladium Price Calculator" category="Finance" />
      </div>
      ...
      <div className="mt-12 space-y-10 max-w-4xl mx-auto">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            ].map((u: any, i: number) =>(<div key={i} className="border-l-4 border-purple-200 pl-5 py-3 bg-white rounded-r-2xl"><h4 className="font-black text-gray-900 mb-1 text-sm">{u.t}</h4><p className="text-gray-600 text-sm leading-relaxed">{u.b}</p></div>))}
          </div>
        </section>
