        ...
        <div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            {[
              ...
              <div key={r.label} className="rounded-xl border p-3 bg-white/80">
                <div className="text-xs text-gray-400">{r.label}</div>
                <div className="font-bold text-gray-900 text-sm">{r.value}</div>
              </div>
            ))}
          </div>
          <div className="rounded-2xl overflow-hidden border mb-3" style={{ height: 380 }}>
            <iframe
              src={mapUrl!}
